...
| `--admin-use-security-key` | `1` verwendet die Anwendung einen zufällig generierten Schlüsselwert, um auf Seiten in Admin und in Formularen zuzugreifen. Diese Schlüsselwerte helfen, Angriffe durch Cross-Site-Script-Forgery zu verhindern. Dies ist der Standard.<br/><br/>`0` Deaktiviert die Verwendung des Schlüssels. | Nein |
