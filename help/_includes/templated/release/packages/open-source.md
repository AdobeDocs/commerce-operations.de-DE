...
Die folgende Referenzdokumentation wird aus der `composer.lock` -Datei und umfasst die erforderlichen Pakete, die in Magento Open Source 2.4.6 enthalten sind.

## Abhängigkeiten

`magento/product-community-edition 2.4.6` weist die folgenden Abhängigkeiten auf:
