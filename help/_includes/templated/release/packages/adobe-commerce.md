...
Die folgende Referenzdokumentation wird aus der Datei `composer.lock` generiert und behandelt die erforderlichen Pakete, die in Adobe Commerce 2.4.7-p1 enthalten sind.
