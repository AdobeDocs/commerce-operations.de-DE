...
B2B für Adobe Commerce verwendet Composer, um PHP-Pakete zu verwalten.
...
Die folgende Referenzdokumentation wird aus der `composer.lock` -Datei und deckt die erforderlichen Pakete ab, die in B2B für Adobe Commerce 1.4.2 enthalten sind.

## Abhängigkeiten

`magento/extension-b2b 1.4.2` hat die folgenden Abhängigkeiten:
