...
Die folgende Referenzdokumentation wird aus der `composer.lock` -Datei, und es umfasst erforderliche Pakete, die in Adobe Commerce 2.4.7-beta3 enthalten sind.

## Abhängigkeiten

`magento/product-enterprise-edition 2.4.7-beta3` weist die folgenden Abhängigkeiten auf:
