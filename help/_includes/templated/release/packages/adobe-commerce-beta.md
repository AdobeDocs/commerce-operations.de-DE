...
Die folgende Referenzdokumentation wird aus der `composer.lock` und es umfasst erforderliche Pakete, die in Adobe Commerce 2.4.7-beta2 enthalten sind.

## Abhängigkeiten

`magento/product-enterprise-edition 2.4.7-beta2` weist die folgenden Abhängigkeiten auf:
