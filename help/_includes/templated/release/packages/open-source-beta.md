...
Die folgende Referenzdokumentation wird aus der `composer.lock` -Datei, und es umfasst erforderliche Pakete, die in Magento Open Source 2.4.7-beta2 enthalten sind.

## Abhängigkeiten

`magento/product-community-edition 2.4.7-beta2` weist die folgenden Abhängigkeiten auf:
