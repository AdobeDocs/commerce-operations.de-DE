...
Die folgende Referenzdokumentation wird aus der `composer.lock` und es umfasst erforderliche Pakete, die in Magento Open Source 2.4.7-beta1 enthalten sind.
