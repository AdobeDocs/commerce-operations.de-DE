...
#### Attributsatzinformationen werden zwischengespeichert (EAV-Cache), aber nicht bereinigt, nachdem der Attributsatz im Administratorbereich aktualisiert wurde

Fehlende Produktattributwerte wurden behoben, nachdem einem Attributsatz neue Attribute hinzugefügt wurden, wenn der EAV-Cache aktiviert ist (Cache-Invalidierung / API-Importverhalten).

_AC-12321 - [GitHub-Problem](https://github.com/magento/magento2/issues/38827) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/38864)_
...
#### Die GraphQL-Mediensammlung gibt deaktivierte Einträge zurück.

Es wurde ein Problem behoben, durch das in der GraphQL-Anfrageantwort nur die Mediensammlungs-Bilder abgerufen wurden, die für ein Produkt nicht deaktiviert sind.

_AC-1608 - [GitHub-Problem](https://github.com/magento/magento2/issues/34342) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/34897)_
...
Zuvor wurden falsch formatierte Anfragetexte oder Parameter an verschiedene REST-API-Endpunkte gesendet (z. B. /V1/carts/search, /V1/orders, /V1/products usw.) führte zu einem generischen „Internen Server-Fehler“ (500), was die Diagnose von Eingabeproblemen erschwert.
...
#### [CLOUD] Warteschlange wird nicht gelöscht

Die Ausfallsicherheit von AMQP-Verbrauchern wurde verbessert, indem ungültige Back-/Reject-Versuche auf wieder verbundenen Kanälen blockiert wurden.

_ACP2E-4621 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Die Überprüfung der Kundenadresse per Telefon funktioniert nicht, wenn keine zulässigen Zeichen vorhanden sind

Das System gibt eine Fehlermeldung zurück, die besagt, dass das Telefon ungültig ist.

_AC-16227 - [GitHub-Problem](https://github.com/magento/magento2/issues/40361) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40416)_

#### Website- und Store-Objekte geben IDs als Zeichenfolgen zurück

Es wurde ein Problem behoben, bei dem Website- und Store-IDs als Zeichenfolgen statt als Ganzzahlen zurückgegeben wurden. Diese Methode behebt Typfehler im strikten Modus, sodass EmailNotification::newAccount() und ähnliche Methoden ordnungsgemäß funktionieren.

_AC-16486 - [GitHub-Problem](https://github.com/magento/magento2/issues/40469)_

#### Die Stadtvalidierung des Kunden funktioniert nicht für nicht zulässige Zeichen

Es wurde ein Problem behoben, bei dem Kundenadressen mit ungültigen Zeichen (z. B. /, @, #, !) gespeichert wurden im Feld Stadt. Nach dieser Fehlerbehebung validiert das System Adressen, die nicht zulässige Zeichen enthalten, korrekt und lehnt sie ab.

_AC-16504 - [GitHub-Problem](https://github.com/magento/magento2/issues/40521) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/57bad413)_

#### [Problem] Behebung: IP-Spaltenlänge für IPv6-Unterstützung in admin_user_session erhöhen

Derzeit ist die IP-Spalte in admin_user_session auf 15 Zeichen beschränkt, was für IPv6-Adressen (bis zu 45 Zeichen) nicht ausreicht. Diese PR verlängert die Länge auf 45, um die vollständige IPv6-Kompatibilität zu gewährleisten und eine Datenabschneidung oder Fehler bei der Verwendung von IPv6 zu vermeiden.

_AC-16659 - [GitHub-Problem](https://github.com/magento/magento2/issues/40570) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40563)_
...
#### Die Überprüfung des Stadtnamens akzeptiert unzulässige Zeichen (!“#?)

Bei der Eingabe einer Stadt in einer Kundenadresse ermöglicht die Validierung jetzt einen Schrägstrich und lehnt ungültige Zeichen wie !, &quot;, #, und ? korrekt ab.

_ACP2E-4527 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/f2fd9628)_

#### Adressenvalidatoren, die bestehende Kundinnen und Kunden nach dem Upgrade auf 2.4.8-p3 beschädigen

Zuvor hatten moderne Telefonnummern vor dieser Fehlerbehebung die Zeichen . oder \ wurden nicht ordnungsgemäß validiert. Nachdem diese Fehlerbehebung angewendet wurde, verwenden moderne Telefonnummern mit den Zeichen . oder \ sind jetzt validiert.

_ACP2E-4554 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Cloud] PHPSESSID nach Anforderung zum Zurücksetzen des Kennworts geändert und aktueller Warenkorb geleert

Vor der Behebung des Problems wurde durch das Übermitteln des Formulars mit vergessenem Passwort die Sitzung zerstört/neu generiert (PHPSESSID geändert) und der Gästekorb geleert. Nach der Behebung des Problems wird die Sitzung durch das Senden des Formulars „Kennwort vergessen“ nicht geändert und der Gastkorb wird beibehalten.

_ACP2E-4524 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problem] Beheben (Admin): korrekte Datumsauswahl-Position in der modalen Folie

Diese Pull-Anfrage behebt ein Problem, bei dem die Magento-Datumsauswahl in modalen Admin-Dialogfeldern nicht korrekt angezeigt wird.
Dies wirkte sich beispielsweise auf den Abschnitt Erweiterte Preise aus, wenn ein Produkt im Admin-Bedienfeld bearbeitet oder erstellt wurde.

_AC-16378 - [GitHub-Problem](https://github.com/magento/magento2/issues/40468) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40225)_

#### Der FTP-Wert auf der Warenkorbseite und der Produktseite unterscheidet sich für dieselben Konfigurationen

Fehlerkorrektur - Auf Produktseiten und Warenkorbseiten werden die FPT-Werte (Fixed Product Tax) aufgrund von Rundungsinkonsistenzen jetzt nicht mehr unterschiedlich angezeigt. Nach dieser Fehlerbehebung sind die FPT-Preise nun auf den Katalog-, Produkt- und Warenkorbseiten einheitlich, wodurch Abweichungen vermieden werden.

_AC-16550 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/8391dbcc)_
...
_ACP2E-4337 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/31258bf6)_
...
#### Die Store-Konfiguration kann im Admin Panel nicht aktualisiert werden

Zuvor konnten der lokale Cache, der veraltete Cache und Redis nicht mehr synchronisiert werden, wenn Redis nicht verfügbar war. Konfigurationsänderungen, die während Redis-Ausfällen vorgenommen wurden, wurden nach der Wiederherstellung von Redis nicht korrekt wiedergegeben, sodass veraltete Werte bestehen blieben. Diese Korrektur stellt eine korrekte Synchronisation über alle Caches hinweg sicher, sodass die zuletzt gespeicherten Werte erhalten bleiben und sichtbar sind, auch wenn Redis ausfällt.

_ACP2E-4447 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e2b23caa)_

#### Archivraster wird nicht mit den neuesten Bestelldaten synchronisiert, wenn die asynchrone Rasterindizierung aktiviert ist

Das Raster für die Kundenauftragsarchivierung zeigt jetzt den korrekten Bestellstatus mit asynchroner Indizierung an.

_ACP2E-4493 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/f2fd9628)_

#### Massenaktualisierung von Produktattributen ändert Produkttyp Virtuell->Einfach

Verhindert das „Hat dies ein Gewicht?“ Steuerelemente vom Aktivieren vor dem Einfügen von Attributfeldern mit Massenaktualisierung, um unbeabsichtigte Gewichtungsänderungen für virtuelle Produkte zu vermeiden.

_ACP2E-4500 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e2b23caa)_

#### Text in PDFs mit mehrseitigen Rechnungen überschneiden sich, wenn Produktname und benutzerdefinierte Optionen lang sind

Vor der Fehlerbehebung konnten sich in mehrseitigen PDFs für Rechnung, Lieferung, Gutschrift und Rückgabe lange Produktnamen mit benutzerdefinierten Optionen nach Seitenumbrüchen mit angrenzenden Spalten/Elementen überschneiden, wodurch Zeilenelementabschnitte unlesbar wurden.
Nach der Korrektur fließen Zeileneinträge jetzt korrekt über Seiten, und lange Namen/Optionen werden in den PDFs „Rechnung“, „Lieferung“, „Gutschrift“ und „Rücksendung“ ohne Überschneidung dargestellt.

_ACP2E-4630 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/d8a248cd)_

#### [Cloud] HugeRTE Editor blockiert Emojis nach dem Upgrade

Vor der Fehlerbehebung blockierte die WYSIWYG/PageBuilder-Validierung modernen 4-Byte-Emoji-Inhalt bedingungslos, da die Benutzeroberflächenregel zu breit angewendet wurde, selbst bei Installationen, bei denen der tatsächliche Speicherpfad utf8mb4-sicher war. Nach der Korrektur wird die Validierung anhand des echten Persistenzpfads entschieden, indem der aktive DB-Verbindungszeichensatz/-sortierung zusammen mit der Zielspaltensortierung überprüft wird, sodass utf8mb4-sicherer Inhalt zulässig ist, während utf8-/utf8mb3-Pfade geschützt bleiben.

_ACP2E-4675 - [GitHub-Code-](https://github.com/magento/magento2/commit/c58a8ad0) - [GitHub-Code-Beitrag](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
### Admin-Benutzeroberfläche, Katalog, Leistung

#### Schlechte Leistung des gettree-Aufrufs in der Mediensammlung

Verbesserte Leistung der Mediensammlung durch Ändern des Ladevorgangs der Verzeichnisstruktur in eine On-Demand-Knotenerweiterung, anstatt die vollständige Baumstruktur im Voraus zu erstellen, wodurch die anfängliche Reaktionszeit der Verzeichnisstruktur bei großen Medienverzeichnissen erheblich verkürzt wird

_ACP2E-4605 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_
...
### Admin-Benutzeroberfläche, Kunde/Kunden

#### Schaltfläche zum Zurücksetzen des Formulars der Benutzeroberfläche funktioniert für das Feld „Mit Unternehmen verknüpfen“ auf der Seite „Hinzufügen und Bearbeiten“ des Kunden nicht wie erwartet

Es wurde ein Problem behoben, bei dem die Zurücksetzen-Schaltfläche das Feld „Mit Unternehmen verknüpfen“ im Kunden-Hinzufügen-/Bearbeitungsformular nicht korrekt zurückgesetzt hat. Das Formular setzt nun alle Felder ohne erneutes Laden der Seite korrekt zurück, wodurch das erwartete Verhalten wiederhergestellt wird.

_AC-16364_

### Admin-Benutzeroberfläche, Import/Export

#### CSV-Datei exportieren steht zum Download zur Verfügung, solange der Export nicht abgeschlossen ist

Vor der Fehlerbehebung wurden die Dateien für den Produktexport in der Warteschlange direkt an ihren endgültigen Speicherort in var/export geschrieben, sodass sie im Admin-Exportraster angezeigt werden und vor Abschluss der Generierung heruntergeladen werden können. Daher konnten Benutzende leere oder teilweise generierte CSV-Dateien herunterladen, und nicht verwandte Dateien, die in var/export vorhanden waren, konnten auch in der Exportliste angezeigt und heruntergeladen werden.
Nach der Fehlerbehebung werden Exporte in die Warteschlange in eine temporäre Datei geschrieben und erst nach erfolgreichem Abschluss der Generierung an den endgültigen Exportspeicherort veröffentlicht. Die Export-Raster- und Download-Aktion „Admin“ zeigt jetzt nur abgeschlossene Exportdateien an, deren Format mit den konfigurierten Exportdateiformatoptionen übereinstimmt. So werden partielle Downloads verhindert und nicht verwandte Dateien von der Benutzeroberfläche ausgeschlossen.

_ACP2E-4724 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c58a8ad0)_
...
### Admin-Benutzeroberfläche, Bestellung, Zahlungen

#### Teilerstattung kann nicht verarbeitet werden - Inkongruenz bei der Berechnung der Erstattung

Die Rückerstattung von Online-Bestellungen funktioniert jetzt ordnungsgemäß. Zuvor wird der Fehler „PayPal-Gateway lehnt die Anfrage ab. Interner Fehler“.

_ACP2E-4615 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c58a8ad0)_

### Admin-Benutzeroberfläche, Leistung

#### Starke Langsamkeit im Staging-Admin-Bedienfeld beim Speichern des Produkts

Das Speichern/Bearbeiten von Admin-Produktformularen ist bei großen Attributsätzen schneller, da teure Client-seitige Validierungsdurchgänge reduziert werden und gleichzeitig das vorhandene Validierungsverhalten beibehalten wird. Dadurch verringert sich die Wahrscheinlichkeit von „Seitenreaktionen“ in der Admin-Benutzeroberfläche.

_ACP2E-4488 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/f2fd9628)_

### Admin-Benutzeroberfläche, Produkt

#### [Cloud] RequireJS mixins.js verursacht doppeltes Laden von Skripten für alle deps-Module.

Vor der Fehlerbehebung konnten einige Storefront-JavaScript-Dateien zweimal angefordert und ausgeführt werden, was zu zeitweiligen doppelten Ladevorgängen und instabilem Verhalten führte. Nach der Behebung werden JavaScript-Abhängigkeiten nur einmal geladen, wodurch doppelte Anforderungen vermieden und die vorhandenen Mixin-Funktionen intakt bleiben.

_ACP2E-4626 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Problem bei der Eingabe im Feld „Ablaufdatum des Geschenkkartenkontos“

Beim Erstellen oder Bearbeiten eines Geschenkkartenkontos in Admin wird das Feld Ablaufdatum jetzt ordnungsgemäß validiert. Zuvor konnten manuell eingegebene Werte, die nicht mit einem gültigen Datumsformat übereinstimmten, beim Speichern des Kontos falsch verarbeitet werden.
...
#### [Problem] Leistungskorrektur für die lange Laufzeit des Cron-Auftrags analytics_collect_data

Die Cron-Auftragsperformance analytics_collect_data wurde für große Datenbanken optimiert, indem Berichtsvalidierungsabfragen auf LIMIT 1 anstelle von LIMIT 0 aktualisiert wurden. Dadurch wird das unnötige Laden vollständiger Tabellendaten während der Validierung verhindert und die Ausführungszeit erheblich verkürzt. Keine funktionalen Auswirkungen, vollständig abwärtskompatible Verbesserung.

_AC-16639 - [GitHub-Problem](https://github.com/magento/magento2/issues/40590) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40463)_
...
#### Maximale Festplatten-E/A-Spitze bei Service-Knoten aufgrund von Aggregate_sales_report_order_data Cron-Auftrag

Es wurde ein Problem behoben, bei dem die Erstellung des Berichts Tägliche aggregierte Aufträge für eine große Anzahl von Aufträgen übermäßig viel Zeit in Anspruch nimmt, was zu Festplatten-E/A-Spitzen und Leistungseinbußen führt. Nach der Behebung wird der Bericht zeitnah generiert.

_ACP2E-4363 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e2b23caa)_

#### [CLOUD] Leistungsbeeinträchtigung aufgrund der Ausführung von analytics_collect_data_cron

Verbessern Sie die Leistung im Zusammenhang mit Cron-Analyseaufträgen.

_ACP2E-4496 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### Gehen Sie zur Kasse und fordern Sie ein Angebot an, das im Warenkorb nicht sichtbar ist, nachdem Sie bei der Anmeldung einen Kunden einem Unternehmen zugewiesen haben

Es wurde ein Problem behoben, bei dem, wenn ein Kunde einem Unternehmen zugewiesen wurde, während er in der Storefront angemeldet war, die Schaltflächen „Zur Kasse gehen“ und „Angebot anfordern“ auf der Warenkorbseite nicht sichtbar waren. Nach dieser Fehlerbehebung werden beide Schaltflächen sofort angezeigt, ohne dass sich der Kunde abmelden und wieder anmelden muss.
...
#### [B2B] Seite Meine Anführungszeichen zeigt keine Anführungszeichen, wenn einige Anführungszeichen gelöschte Produkte enthalten

Mein Zitat zeigt jetzt die Anführungszeichen korrekt an, wenn einige Anführungszeichen gelöschte Produkte enthalten.

_ACP2E-4608 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Mehrere Gutscheine funktionieren für Google Pay nicht wie erwartet

Es wurde ein Problem behoben, bei dem mehrere Gutscheincodes in der Google Pay Express-Zahlungsliste nicht wie erwartet funktionierten. Zuvor würde die Anwendung eines zweiten Couponcodes fälschlicherweise den Rabatt des ersten Coupons entfernen und ungenaue Summen anzeigen. Durch das Entfernen von Coupons wurde auch die Zahlungsliste nicht korrekt aktualisiert.
Kunden können jetzt mehrere Gutscheincodes in der Google Pay Express-Zahlungsliste anwenden, und alle Rabatte werden genau angezeigt.

_BUNDLE-3507_

#### Braintree SDK erhält auf jeder Seite einen Aufruf, um das Client-Token zu erhalten, selbst wenn die Option „Später bezahlen“ deaktiviert ist

Die Braintree-SDK führte bei jedem Seitenladevorgang einen Aufruf zum Abrufen des Client-Tokens aus, selbst wenn die Pay Later-Nachricht deaktiviert war. Dies führte zu unnötigen Anfragen und potenziellen Leistungsproblemen.
Das System fordert das Braintree-Client-Token jetzt nur noch an, wenn sowohl die PayPal-Zahlungsmethode als auch die Pay Later-Nachricht für den Warenkorb aktiviert sind. Dadurch werden unnötige Token-Anfragen verhindert und die Seitenladeleistung verbessert.

_BUNDLE-3508_

#### Beenden des Renderns der Vaulting-Vorlage und der JS-Dateien der Braintree-Zahlungsmethoden im Abschnitt „Gespeicherte Zahlungsmethoden“ im Kundenkontobereich

JavaScript- und Vorlagendateien für Braintree-Zahlungsmethoden wurden im Abschnitt „Gespeicherte Zahlungsmethoden“ des Kundenkontenbereichs gerendert, auch wenn Braintree-Zahlungsmethoden und Vaulting-Konfigurationen deaktiviert waren. Dies führte zu unnötigen Fehlern in der Browser-Konsole.
Das System prüft jetzt, ob die Braintree-Zahlungsmethode und ihre Vaulting-Konfiguration aktiviert sind, bevor zugehörige Dateien und Formulare gerendert werden. Nur wenn beide aktiviert sind, werden die Vaulting-Vorlagen und -Skripte im Abschnitt „Gespeicherte Zahlungsmethoden“ angezeigt.

_BUNDLE-3509_

#### Kompatibilitätsprobleme zwischen Apple Pay und Google Pay Third-Party

Kunden stießen auf Fehler, wenn sie versuchten, Zahlungen über Apple Pay oder Google Pay mit Checkout-Erweiterungen von Drittanbietern (wie Hyvä Checkout) oder Anpassungen vorzunehmen. Insbesondere würde Apple Pay einen TypeError aufgrund eines fehlenden Händlernamens auslösen, und Google Pay könnte ebenfalls je nach benutzerspezifischen Code-Interaktionen fehlschlagen.
Kompatibilitätsprobleme mit Apple Pay und Google Pay wurden behoben. Das System verarbeitet jetzt ordnungsgemäß Checkout-Erweiterungen und -Anpassungen von Drittanbietern, um sicherzustellen, dass die erforderlichen Konfigurationswerte vorhanden sind und korrekt zurückgegeben werden.

_BUNDLE-3510_

#### Google Pay über Braintree führt zu unendlicher Belastung während des Checkouts

Wenn Google Pay über Braintree aktiviert wurde, wechselte der Checkout-Prozess in einen unendlichen Ladestatus, nachdem Google Pay als Zahlungsmethode ausgewählt worden war. Dies hinderte Kundinnen und Kunden daran, ihre Bestellungen ohne Fehlermeldung oder Feedback abzuschließen.
Die Google Pay-Integration über Braintree wurde korrigiert, um sicherzustellen, dass der Zahlungsfluss wie erwartet verläuft. Kunden können jetzt während des Checkouts Google Pay auswählen, den Zahlungsprozess abschließen und Bestellungen erfolgreich aufgeben.
...
#### Zwischensumme zeigt 0 an, nachdem mit mehreren Adressen ausgecheckt und eine andere Option als das konfigurierbare Produkt hinzugefügt wurde

Es wurde ein Problem behoben, bei dem die Zwischensumme des Warenkorbs fälschlicherweise als 0 angezeigt wurde, nachdem eine andere Option eines konfigurierbaren Produkts nach dem Checkout mit mehreren Adressen hinzugefügt wurde. Die Zwischensumme spiegelt nun korrekt den tatsächlichen Warenkorbwert wider.

_AC-14460 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/57bad413)_
...
#### [Problem] Aufruf von RemoveItem im Warenkorb anstelle von ItemRepository

Ersetzt die deleteById-Aufrufe im CartItemRepository durch removeItem in der Cart-Instanz.
Dadurch wird sichergestellt, dass die erwarteten Beobachter ausgelöst werden und das Element tatsächlich auch im Warenkorbobjekt aktualisiert wird, anstatt nur in der Datenbank.

_AC-15963 - [GitHub-Problem](https://github.com/magento/magento2/issues/40255) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40248)_
...
#### Warenkorb-Preisregel-Rabatt funktioniert nicht mit der Bedingung „SKU ausschließen“

Fehlerkorrektur - Die Regeln zum Warenkorbpreis werden jetzt korrekt angewendet, wenn in der Zwischensummenberechnung ausgeschlossene SKUs vorhanden sind. Die Rabattlogik ignoriert jetzt ausgeschlossene Elemente bei der Auswertung von Regelbedingungen korrekt.

_AC-16417 - [GitHub-Problem](https://github.com/magento/magento2/issues/40503) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/8391dbcc)_
...
Vor der Fehlerbehebung beim Abbrechen der Option zum mehrmaligen Versand war die Adresse beim Zurücksetzen auf den mehrmaligen Versand nicht vorausgewählt. Jetzt wird die Standardadresse durch eine der Optionen ersetzt, die im Multi-Shipping-Bildschirm ausgewählt wurden.
...
#### Menge, die beim Hinzufügen von BUNDLE-Produkten im Admin-Kunden-Warenkorb als 0 angezeigt wird  
...
_ACP2E-4245 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/cbca0396)_
...
#### [CLOUD] Problem beim Anwenden einer Geschenkkarte mit Recaptcha v2 („Ich bin kein Roboter„)

Geschenkgutscheine werden jetzt korrekt angewendet, wenn reCAPTCHA v2 („Ich bin kein Roboter„) nach erfolgreicher reCAPTCHA-Validierung aktiviert ist.

_ACP2E-4410_

#### Bei Verwendung der Option Anmeldung als Kunde von Administrator wird ein Nullangebot erstellt

Es wurde ein Problem behoben, das dazu führte, dass während des Flusses „Als Kunde anmelden“ ein Nullangebot erstellt wurde.

_ACP2E-4472 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e2b23caa)_

#### Inkonsistenzen im Verhalten von Bundle-Produkten mit Flatrate-Versand und kostenlosem Versand

Vor der Fehlerbehebung wurde der kostenlose Versand für Bundle-Produkte nicht ordnungsgemäß berechnet, wenn er über Warenkorb-Rabattregeln bereitgestellt wurde. Nach der Fehlerbehebung wird der kostenlose Versand für Bundle-Produkte ordnungsgemäß berechnet.

_ACP2E-4536 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_

#### Bestellung von Produkten mit numerischen SKUs nicht möglich

Das System gibt beim Aufgeben einer Bestellung für ein Produkt mit einer numerischen SKU keinen Fehler mehr aus.

_ACP2E-4669 - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/83d11138)_

#### Validierungsregeln für Kundenadressattribute (EAV) stehen im Konflikt mit hart codierten Validierungsregeln.

Verbesserte telefonische Validierung der Kundenadresse zur Unterstützung von Werten bis zu 255 Zeichen, wobei Server-seitige Prüfungen an den Datenbankbeschränkungen ausgerichtet werden. Die Fehlerbehandlung wurde ebenfalls verfeinert, sodass überlange Telefonnummern eine klare, längenspezifische Nachricht zurückgeben.

_ACP2E-4735 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [Coupon] Fehler bei doppelten Couponeinträgen in der Tabelle quote_coupons

Fehlerkorrektur - In der Tabelle quote_coupons wurde ein zeitweiliger Fehler mit doppelten Schlüsseln behoben, wenn mehrere Anfragen zum Zusammenführen des Warenkorbs oder zum Speichern des Angebots gleichzeitig ausgeführt wurden.
...
_ACP2E-4266 - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/ae1f272f)_
...
### Warenkorb und Checkout, Leistung

#### [TOYOTA] Leistungsproblem mit der Klasse Magento\Store\Model\System\Store

Leistungsverbesserung in Bezug auf mehrere Stores und Websites.

_ACP2E-4491 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e2b23caa)_

### Warenkorb und Checkout, Preise, Steuer

#### Die Produktpaketpreise zeigen in einer Einrichtung mit mehreren Währungen falsche Steuer- und Währungswerte zwischen PDP und Warenkorb an.

Die Produktpaketpreise werden jetzt korrekt zwischen den Seiten von PDP und Checkout angezeigt.

_ACP2E-4673 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [\Magento\ConfigurableProduct\Model\Product\Type\Configurable] PHP-Fehler unbemerkt
...
#### Magento-Produktlisten-Widget gibt eine falsche Anzahl zurück

Das Adobe Commerce-Widget Katalogproduktliste gibt jetzt die richtige Gesamtanzahl und Paginierung zurück (z. B. 9 Elemente auf mehreren Seiten, wie konfiguriert).

_AC-14541 - [GitHub-Problem](https://github.com/magento/magento2/issues/39863) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40421)_
...
#### Automatische Generierung von Meta-Tags: Variablen können nicht mehrmals verwendet werden

Die automatische Generierung von Produkt-Meta-Keywords ersetzt jetzt alle Platzhalter in der konfigurierten Maske (z. B. `{{name}}, order {{name}}`), nicht nur das erste Vorkommen.

_AC-14626 - [GitHub-Problem](https://github.com/magento/magento2/issues/35670) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40412)_
...
#### Die Kundengruppen-ID des Unternehmens wird nicht der Kundengruppen-ID des Unternehmensadministrators zugewiesen, wenn der Unternehmensadministrator geändert wird

Beim Ändern des Administrators eines Unternehmens im B2B-Bereich wurde die Kundengruppen-ID des neuen Unternehmensadministrators nicht entsprechend dem zugewiesenen freigegebenen Katalog des Unternehmens aktualisiert. Dies führte dazu, dass die Stufenpreise und Kategorieberechtigungen für den neuen Administrator auf der Kundengruppe des vorherigen Unternehmens basierten, was zu falschen Preisen und Berechtigungen führte.
Das System aktualisiert jetzt die Kundengruppen-ID des Unternehmensadministrators korrekt, wenn der Administrator geändert wird. Dadurch wird sichergestellt, dass der neue Administrator bzw. die neue Administratorin die richtigen Stufenpreise und Kategorieberechtigungen erhält, die mit dem freigegebenen Katalog des Unternehmens verknüpft sind.

_AC-14897 - [GitHub-Problem](https://github.com/magento/magento2/issues/39964)_
...
#### Website des Warnhinweises zu Produktbeständen und Problem mit nicht übereinstimmender Lager für mehrere Websites

Diese Fehlerbehebung umfasst die Tabellen website_id und store_id aus product_alert_stock und product_alert_price in der SELECT-Klausel der Sammlung. So wird sichergestellt, dass im Admin-Raster die richtige Website angezeigt wird, auf der jeder Warnhinweis abonniert wurde.

_AC-15044 - [GitHub-Problem](https://github.com/magento/magento2/issues/40027) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40431)_
...
#### [Problem] Fehler beim Besuch einer Vergleichsseite ohne Elemente behoben

Es wurde ein Fehler behoben, durch den beim Besuch der Produktkatalogvergleichsseite ohne Vergleichselemente ein schwerwiegender Fehler verursacht wurde, indem sichergestellt wurde, dass leere Elementauflistungen durch die Vergleichsaktion sicher verarbeitet werden, anstatt Ausnahmen auszulösen.

_AC-15746 - [GitHub-Problem](https://github.com/magento/magento2/issues/40205) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40203)_
...
#### E-Mail-Abholung im Laden verwendet noch immer veraltete Methoden

Keine Beschreibung verfügbar.

_AC-16380 - [GitHub-Problem](https://github.com/magento/inventory/issues/3384) - [GitHub-Code-](https://github.com/magento/inventory/pull/3385) - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/b4aeda50)_
...
Es wurde ein Problem behoben, bei dem gelöschte Dropdown-Optionen beim Erstellen von Produktattributen weiterhin beibehalten wurden. Das System entfernt nun die ausgewählten Optionen korrekt und gibt die genaue Anzahl nach dem Speichern wieder.

_AC-16437 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/57bad413)_
...
Nach der Behebung generiert der mit `--skip_hidden_images` Flag verwendete `catalog:images:resize`-Befehl keine Bild-Caches für Websites, auf denen Bilder nicht vorhanden sind.
...
#### [CLOUD] Zirkuläre Kategorieabhängigkeit

Vor der Behebung konnten Sie Kategorien mit zirkulärer Abhängigkeit speichern. Nach der Behebung wird dieses Verhalten durch eine Validierungsregel verhindert.

_ACP2E-4505 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/f2fd9628)_

#### Die CMS-Hierarchie aktualisiert die hierarchische URL nicht, wenn der URL-Schlüssel der untergeordneten Seite geändert wird (2.4.8-p3)

Es wurde ein Problem behoben, bei dem durch Ändern des URL-Schlüssels einer CMS-Seite die hierarchische URL der Seite nicht aktualisiert wurde (z. B. blieb /help/my-account nach dem Umbenennen in my-account-2 gleich). Die Logik zur Aktualisierung der Hierarchie enthält jetzt korrekt den eigenen Knoten der Seite, sodass ihre request_url aktualisiert wird und der neue Pfad (z. B. /help/my-account-2) erwartungsgemäß funktioniert.

_ACP2E-4531_

#### Bild-Platzhalter wird für verschiedene Stores nicht wie erwartet angezeigt

Vor der Fehlerbehebung wurden Platzhalterbilder nicht in den Store-Code geladen, wenn diese in die URL eingefügt wurden. Nach der Fehlerbehebung wird bei Platzhaltern für Bilder zwischen Umfang unterschieden, wobei der in der URL bereitgestellte oder nicht gespeicherte Code verwendet wird.

_ACP2E-4533 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/aa2e16d1)_

#### [CLOUD] Blockierung der Tabelle magento_catalogpermissions_index_product. Fortsetzung

Vor der Korrektur konnte die laufende Katalogberechtigungen-Produktneuindizierung vorhandene Berechtigungsindexzeilen unverändert lassen, sodass aktualisierte Kategorieberechtigungen nicht zuverlässig auf Produkten widergespiegelt wurden.
Nach der Behebung aktualisiert die Neuindizierung die vorhandenen Berechtigungsindexzeilen korrekt, sodass Berechtigungsänderungen konsistent auf den Storefront-Zugriff, die Preissichtbarkeit und die Checkout-Verfügbarkeit angewendet werden.

_ACP2E-4603_

#### Der Target-Regel-Indexer von Cron wählt keine Produkte aus, die nur im Bereich der Store-Ansicht aktiviert sind.

Vor der Fehlerbehebung wurden Produkte, die nicht im Admin-Bereich aktiviert waren, vom Zielregelindizierer nicht abgerufen. Nach der Fehlerbehebung werden Produkte übernommen, wenn sie in mindestens einem Umfang aktiviert sind.
...
#### [Cloud] - Fehler wird angezeigt, wenn der Wert catalog_product_entity_int für attribute_type 0 oder Null in den GraphQL-Produkten auswählt

Es wurde ein Problem behoben, bei dem die GraphQL-Produktabfrage mit Aggregationen einen Fehler mit ungültigen Attributwerten oder Optionen zurückgibt. Die Abfrage verarbeitet jetzt ungültige Daten korrekt und gibt korrekte Ergebnisse zurück.

_ACP2E-4529 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### Die Ordnerstruktur der Mediensammlung wird ausgeblendet, wenn der Name des Kategoriebilds mit &quot;-&quot; beginnt (Bindestrich)

Keine Beschreibung verfügbar.

_AC-16544 - [GitHub-Problem](https://github.com/magento/magento2/issues/40536)_

#### Beim Speichern des CMS-Blocks „Auflister für Katalogereignisse“ wird der Fehler &quot;CMS-Block enthält ungültigen Inhalt“ angezeigt

Fehlerkorrektur - Beim Speichern des standardmäßigen CMS-Blocks „Catalog Events Lister“ wird jetzt der Fehler &quot;CMS-Block enthält ungültigen Inhalt“ angezeigt. Nach dieser Fehlerbehebung kann der Block im Admin-Bedienfeld erfolgreich und fehlerfrei gespeichert werden.

_AC-16686 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/0c9a749b)_
...
#### [ADOBE STOCK] Kritische Protokolle bei &quot;Adobe Stock-Suchergebnisse konnten nicht abgerufen werden“, selbst wenn die Integration deaktiviert ist.

Das System protokolliert den Fehler &quot;Adobe Stock-Suchergebnisse konnten nicht abgerufen werden“ nicht mehr, wenn die Adobe Stock-Integration deaktiviert ist.

_ACP2E-4634_

#### Fehler beim Erstellen neuer Seiten und beim Auslösen des Fehlers in Page Builder

Es wurde ein Problem behoben, bei dem CMS-Seiten bei Verwendung von Page Builder nicht gespeichert wurden.
...
_AC-14940 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/3e41a43b)_
...
Diese PR ermöglicht es Formularelementen mit mehreren Werten, Daten an Websites/Gruppen/Store-Formulare zu senden.
...
_AC-14883 - [GitHub-Problem](https://github.com/magento/magento2/issues/39947) - [GitHub-Code-](https://github.com/magento/magento2/commit/3717e6cb) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/d3ea191d)_
...
_AC-15446 - [GitHub-Problem](https://github.com/magento/magento2/issues/40170) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e9412b24)_
...
#### NewRelic-Modul - Entfernen nicht benötigter Abhängigkeiten

Entfernt die unnötige Magento/Magento-Composer-Installer-Abhängigkeit vom magento/module-new-relic-reporting-Modul, um nicht verwendete/enge Kopplungen in Abhängigkeiten zu bereinigen

_AC-15945 - [GitHub-Problem](https://github.com/magento/magento2/issues/40243)_
...
*KEINE VERSIONSHINWEISE ERFORDERLICH*
...
Vor der Fehlerbehebung konnte es zu Problemen kommen, wenn benutzerdefinierte JavaScripts über den head-Abschnitt geladen wurden. Nach der Einführung der neuen Einstellung können solche Skripte automatisch zurückgestellt werden, um eine bessere Kompatibilität mit dem Magento 2-Framework zu gewährleisten.
...
#### Cron CAPTCHA_DELETE_EXPIRED_IMAGES funktioniert nicht nach der Aktualisierung auf Magento 2.4.8

Vor der Fehlerbehebung wurden abgelaufene CAPTCHA-Bilder nicht mehr automatisch gelöscht. Nach der Fehlerbehebung werden abgelaufene CAPTCHA-Bilder durch die entsprechende Cron-Aufgabe gelöscht.

_ACP2E-4512 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e2b23caa)_

### Framework, Leistung

#### [CLOUD] Langsame MySQL-Abstimmabfrage im Verkaufsraster asynchron Cron - vollständiger Tabellenscan, 20+ s, ~14 Millionen Zeilen untersucht

Verbesserte Leistung bei der asynchronen Abstimmung des Vertriebsrasters durch Wechsel der Erkennung fehlender IDs zu begrenzten entity_id-Fenstern mit Cursor-basierter Progression, wodurch die Anzahl wiederholter Scans großer Tabellen in Speichern mit hohem Volumen reduziert wird.

_ACP2E-4585 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### AC-2.4.9 - Bestellungen auf EDS-Textbaustein können nicht durchsucht werden

Der Abfrageeingabetyp guestOrder GraphQL wurde auf GuestOrderInformationInput anstelle von OrderInformationInput aktualisiert.

_LYNX-872_

#### [AC-2.4.9] Warenkorbabfrage gibt einen falschen Verfügbarkeitsstatus für Produkte mit Multi-Source Inventory (MSI) zurück und der Standardbestand ist 0

Es wurde ein Problem behoben, bei dem die Warenkorb-API fälschlicherweise Is_Available zurückgegeben wurde: false für Produkte, die über ein ausreichendes Inventar aus mehreren Source-Inventarquellen (MSI) verfügten.

_LYNX-918_

#### [AC-2.4.9] Die Versand-/Rechnungsadresse eines Kunden kann nicht mit setNegotiableQuoteShippingAddress/setNegotiableQuoteBillingAddress GQLs festgelegt werden

Das Feld uid in der GraphQL-Abfrage zur Kundenadresse wurde angezeigt, um das Festlegen von Versand- und Rechnungsadressen in verhandelbaren Anführungszeichen zu ermöglichen.

_LYNX-924_

#### [AC-2.4.9] Auftragsliste | Interner Server-Fehler

Gewährleistete Stabilität in den Auftragsflüssen durch die Rückgabe von Null für fehlende gekaufte Produkte, Vermeidung von Ausnahmen in der Auftragsgeschichte und in den letzten Bestellungen.

_LYNX-937_

#### [AC-2.4.9] Ausrichten von NegotiableQuoteBillingAddressInput an BillingAddressInput

&#39;
Abgestimmte Werte für NegotiableQuoteBillingAddressInput, BillingAddressInput, ShippingAddressInput und GiftRegistryShippingAddressInput zur Unterstützung der Kundenadressen-UID bei veralteter Kundenadressen-ID.
Es wurden die Mutationen deleteCustomerAddressV2 und updateCustomerAddressV2 eingeführt, um die Kundenadressen-UID zu unterstützen, und die vorhandenen Mutationen deleteCustomerAddress und updateCustomerAddress wurden eingestellt.
...
### GraphQL, Bestellung, Preise

#### [Cloud] Die Abfrage „SalesGraphQL customerOrders“ gibt falsche Werte für die Bestellartikelfelder zurück

Es wurde das Problem behoben, bei dem die Abfrage „SalesGraphQL customerOrders“ überhöhte Werte für „original_price_include_tax“ und „original_row_total_include_tax“ zurückgab, wenn Katalogpreise auf „einschließlich Steuer“ eingestellt waren, da Steuern ein zweites Mal auf Preise angewendet wurden, die bereits Steuer enthielten.

_ACP2E-4762 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### CSV-Produkte zu erweiterten Preisen, CSV-Produkte werden nicht exportiert. OOM auch bei 4G-Speicherbegrenzung

Vor der Fehlerbehebung konnten vollständige Produkt- und Advanced-Pricing-Exporte bei großen Katalogen mit hoher Speichernutzung/OOM fehlschlagen und die Paginierung von Produktexporten konnte doppelte Zeilen produzieren, wenn sich die dynamische Seitengröße während der Verarbeitung änderte. Nach der Behebung werden Exporte mit stabilem Speicherverhalten durch seitenweise Batch-Verarbeitung abgeschlossen, doppelte Zeilen aus der Paginierung werden überlagert, und der exportierte Zeileninhalt bleibt mit der Baseline-Ausgabe ausgerichtet.

_ACP2E-4587 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Status der Bundle-Verkaufsfähigkeit wird beim Stornieren der Bestellung nicht aktualisiert

Die Verkaufsfähigkeit des Bundles wurde nach Stornierung der Bestellung jetzt korrekt berechnet.

_ACP2E-4481 - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/96b77663)_

#### Magento ermöglicht einen Überverkauf, wenn mehrere Kunden gleichzeitig Bestellungen aufgeben

Mit MSI könnten mehrere Kunden gleichzeitig Bestellungen für dasselbe Produkt aufgeben und die verfügbaren Lagerbestände überschreiten, was zu Überverkäufe führen würde. Nach der Behebung kann pro Produkt nur eine Bestellung erfolgreich sein, wenn der Checkout gleichzeitig ausgeführt wird, sodass kein Überverkauf mehr stattfindet.

_ACP2E-4509 - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/a33c60f2)_

#### [CLOUD] Zeitüberschreitungen, wenn Kunden mehr als 140 Artikel im Warenkorb haben

Inventar-Datenbankabfragen wurden optimiert, um Inventardaten während des Checkouts eifrig zu laden. Dadurch entfallen individuelle Abfragen für jede SKU, was bei großen Warenkörben zu einer deutlichen Leistungssteigerung führt.

_ACP2E-4519 - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/40858072)_

### Loyalität

#### [CLOUD] getCustomerRewardPoints löst eine Ausnahme aus, wenn der Kunde keine Punkte hat

Bonuspunkte für Kunden werden erfolgreich initiiert, wenn sie über den Administrator erstellt wurden.

_ACP2E-4403 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Rechnung: addComment kann einen Fehler auslösen, wenn Rechnung getComments zuerst aufgerufen wird

Diese PR behebt einen kritischen Fehler, bei dem der Aufruf von $bill->getComments() vor $bill->addComment() einen schwerwiegenden Fehler verursachte: „Aufruf einer Funktion addItem() für Array“. Der Fix implementiert eine ordnungsgemäße Typüberprüfung und Konvertierung zwischen Array- und Sammlungstypen in den Kommentarmethoden des Rechnungsmodells, sodass beide Methoden in beliebiger Reihenfolge und ohne Fehler aufgerufen werden können, während die Abwärtskompatibilität gewahrt bleibt.

_AC-14848 - [GitHub-Problem](https://github.com/magento/magento2/issues/39884) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40428)_
...
#### Verkauf->Auftragsraster „Lieferadresse“ Spalte fehlt Land

Es wurde ein Problem behoben, bei dem in der Spalte „Lieferadresse“ im Raster „Admin-Bestellungen“ das Land für internationale Bestellungen nicht angezeigt wurde. Die Adresse enthält jetzt Länderinformationen, die die Sichtbarkeit und Benutzerfreundlichkeit der Bestellung verbessern.

_AC-16256 - [GitHub-Problem](https://github.com/magento/magento2/issues/40403) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/3e41a43b)_

#### Verbraucher für asynchrone Bestellung lehnt Bestellungen mit verzögerter Lageraktualisierung ab: NoSuchEntityException in CartManagementPlugin::getActive() (inaktives Angebot)

Es wurde ein kritisches Problem behoben, bei dem ein asynchroner Checkout mit einer verzögerten Stock-Aktualisierung für Gastbestellungen fehlschlug. Zuvor gab der Verbraucher aufgrund inaktiver Anführungszeichen eine NoSuchEntityException aus, sodass Bestellungen als Abgelehnt anstatt als Ausstehend markiert wurden. Nach dieser Fehlerbehebung verarbeitet der Verbraucher inaktive Angebote korrekt, verschiebt Bestellungen von „Eingegangen“ in „Ausstehend“ und passt die Verkaufsmengen wie erwartet an. MFTF-Test „AsyncOrderWithAsyncStockReservationTest“ wird jetzt bestanden.

_AC-16680 - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
Vor der Fehlerbehebung waren bei Verwendung des asynchronen E-Mail-Versands die Versand-E-Mails nicht mit der Bestellung im Geschäft konsistent. Nach der Fehlerbehebung wird nun die richtige E-Mail-Bestellung für die Ladenlieferung zugestellt.
...
#### GraphQL cancelOrder storniert keine Bestellungen, die vollständig mit der Geschenkkarte bezahlt wurden

Vor der Fehlerbehebung ging eine Bestellung, die vollständig über eine Geschenkkarte bezahlt wurde, nicht automatisch in den Status „Geschlossen“ über, wenn sie über eine GraphQL-Mutation aufgerufen wurde. Nach der Fehlerbehebung wird die Bestellung jetzt in den Status „Geschlossen“ versetzt, wenn sie über GraphQL storniert wird.

_ACP2E-4455 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/e2b23caa)_

#### Die Couponnutzung wird bei Stornierung/Ablehnung der Bestellung nicht zurückgesetzt

Wenn Sie eine Bestellung abbrechen, wird die angewendete Couponnutzung jetzt korrekt zurückgesetzt, auch wenn die Konfiguration des Bestellstatus geändert wurde. Dies kann dazu führen, dass Coupons nach Stornierung einer Bestellung weiterhin als „Verwendet“ gekennzeichnet bleiben, wenn benutzerdefinierte Bestellstatuseinstellungen vorhanden sind.
...
#### Warenkorbpreisregeln basierend auf Kundensegmenten verzögern registrierte Benutzer.

Es wurde ein Problem behoben, bei dem Regeln zum Warenkorbpreis, die auf Kundensegmenten basieren, für registrierte Benutzer nicht sofort angewendet wurden. Der Rabatt gilt jetzt korrekt, wenn ein qualifizierendes Produkt zum Warenkorb hinzugefügt wird, ohne dass eine Token-Aktualisierung erforderlich ist.

_LYNX-814_

#### GQL - Mengenfeld in ProductInterface gibt keine verkaufsfähige Menge zurück

Es wurde ein GraphQL-Problem behoben, bei dem das Mengenfeld in der ProductInterface die verkaufsfähige Menge nicht zurückgab.

_LYNX-816_

#### Für das Feld „SelectedShippingMethod.carrier_code“, in dem keine NULL-Werte zulässig sind, kann nicht null zurückgegeben werden.

Es wurde ein Problem behoben, bei dem die Auswahl der zweiten Versandmethode beim Checkout mit einer US-Adresse dazu führte, dass für das nicht löschbare Feld „SelectedShippingMethod.carrier_code“ der Fehler „Cannot return null“ zurückgegeben wurde. Diese Fehlerbehebung sorgt für eine reibungslose Navigation zum Auschecken, ohne interne Server-Fehler auszulösen.

_LYNX-817_

#### [AC-2.4.9] addProductsToCartMutation gibt bei einem Fehler 200 zurück

Der neue Fehlercode REQUIRED_PARAMETER_MISSING wurde eingeführt, um Benutzerfehler zu verarbeiten, wenn konfigurierbare Produktoptionen beim Hinzufügen zum Warenkorb nicht ausgewählt werden.

_LYNX-884_

#### [AC-2.4.9] Fehler beim Anfordern des Felds „CartItem.not_available_message“ oder „is_available“, wenn die Prüfung des Warenkorbbestands deaktiviert ist

Fehlerkorrektur - Der Zugriff auf die Funktion „not_available_message“ oder „is_available“ auf den Warenkorb-Artikel funktioniert jetzt, wenn die Prüfung des Warenkorbbestands deaktiviert ist.
...
#### Cron-Auftrag aufgrund von OOM blockiert - Anfrage zur Überprüfung von innodb_buffer_pool_size und PHP memory_limit für Cron

Die Verarbeitung von Zahlungsvorgängen wurde verbessert

_ACP2E-4601 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c12a7510)_
...
Vor der Behebung waren die Cache-Schlüssel für Remote-Speicher-Metadaten nicht abgelaufen. Nach der Behebung können Sie jetzt eine TTL für solche Cache-Schlüssel durch Injektion von Abhängigkeiten festlegen.
...
_ACP2E-4610 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c58a8ad0)_

#### Unterkategorien der letzten Ebene zeigen in der Kategoriestruktur „Admin“ eine Nullproduktzahl an

Vor der Fehlerbehebung enthielten Blattkategorien keine Produktzahl, wenn sie in der Kategoriestruktur des Administratorbereichs angezeigt wurden. Nach der Fehlerbehebung wird die Produktanzahl für jedes Kategorieblatt korrekt angezeigt.

_ACP2E-4689 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/d8a248cd)_

#### Langsame Abfrageleistung in der Tabelle „magento_reward_history“ aufgrund der großen Datenmengen

Es wurde ein Problem behoben, bei dem der Cron-Vorgang zur Gültigkeit der Belohnungspunkte bei großen magento_reward_history-Tabellen langsam ausgeführt wurde. Zuvor fehlten in der Abfrage, die von der geplanten Punktegültigkeit verwendet wurde, zusammengesetzte Datenbankindizes, was zu vollständigen Tabellenüberprüfungen in Tabellen mit Millionen von Datensätzen führte.
...
#### Bestellung oder Filterung nach Preis funktioniert nicht für nicht vorrätige Paketprodukte

Wenn die Option „Nicht vorrätige Produkte anzeigen“ aktiviert ist, filtert die Produktlistenseite jetzt nicht mehr vorrätige Produkte korrekt nach Preis und sortiert sie.

_ACP2E-4475 - [GitHub-Code-](https://github.com/magento/magento2/commit/f2fd9628) - [GitHub-Code-Beitrag](https://github.com/magento/inventory/commit/a33c60f2)_
...
#### Unnötig maskierte Zeichen in der Produktoberfläche

Das System gibt jetzt unverschlüsselte `>` im Namen in der GraphQL-Antwort zurück.

_AC-15494 - [GitHub-Problem](https://github.com/magento/magento2/issues/40178) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40423)_
...
#### Inkrementeller Zielregel-Indexer wählt keine deaktivierten Produkte aus

Die inkrementelle Indizierung der Target-Regel reagiert jetzt, wenn ein Produkt aktiviert oder deaktiviert wird, um sicherzustellen, dass die zugehörigen/Upsell-/Crosssell-Recommendations ohne vollständige Neuindizierung aktualisiert werden.

_ACP2E-4402_

#### Die Kundensegmentierung funktioniert nicht ordnungsgemäß mit der REST-API

Kundensegmente, die auf der Bestellanzahl basieren, werden jetzt korrekt aktualisiert, wenn Bestellungen über die REST-API aufgegeben werden. Zuvor wurde die Segmentzugehörigkeit für API-Bestellungen nicht aktualisiert, da sich der Beobachter auf die Kundensitzung verlassen hat, die in API-Anfragen nicht verfügbar ist.

_ACP2E-4590_

#### Warenkorb-Preisregel kann nicht mit der Aktionsbedingung „Kategorie (nur untergeordnete Elemente)“ über die REST-API erstellt werden

Es wurde ein Problem behoben, bei dem ein Attributbereich für Warenkorbpreisbedingungen, z. B. Kategorie (nur übergeordnet) und Kategorie (nur untergeordnete Elemente), nicht verfügbar gemacht wurde, wenn Regeln über die REST-API abgerufen oder aktualisiert wurden.

_ACP2E-4653 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/d8a248cd)_

#### Die Regeln zum Warenkorbpreis für den kostenlosen Versand funktionieren für Bundle-Produkte nicht wie erwartet

Verbesserte Handhabung des kostenlosen Versands

_ACP2E-4720 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/c58a8ad0)_

### Rückgabe

#### Problem bei einfacher Optionsauswahl bei der Rückgabe von Bundle-Produkten

Zuvor, vor der Implementierung dieser Fehlerbehebung, wurde für Bundle-Produkte mit der Option, Artikel separat für Rücksendungen zu versenden, mit der Funktion „Artikel auswählen“ der Popup-Block nur zum ersten Mal geöffnet. Nach dem Auswählen oder Schließen des Popup-Blocks wurde dieser nicht jedes Mal geöffnet, wenn die Funktion „Elemente auswählen“ aufgerufen wurde. Nach der Anwendung dieser Fehlerbehebung wurde das Problem jedoch behoben, und die Funktion funktioniert jetzt wie beabsichtigt.
...
#### Fehlermeldung wird für GET-Anfrage nicht gerendert

Es wurde ein Problem behoben, bei dem Fehlermeldungen für ungültige GET-Anfragen nicht sofort angezeigt wurden. Fehlermeldungen werden jetzt korrekt angezeigt, ohne dass zusätzliche Benutzeraktionen erforderlich sind, was das Benutzer-Feedback und die Konsistenz verbessert.

_AC-16296 - [GitHub-Problem](https://github.com/magento/magento2/issues/40411) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/8391dbcc)_

#### Transliteration: fehlende Zeichen

Das System verarbeitet jetzt Transliteration fehlender Zeichen korrekt

_AC-16626 - [GitHub-Problem](https://github.com/magento/magento2/issues/40580) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40581)_
...
#### AC-15210 scheint nicht vollständig zu sein. USPS REST API in weniger als einem Monat erforderlich.

Die Integration der USPS REST-API in Adobe Commerce (AC-15210) war unvollständig. Zu den Hauptproblemen gehörten fehlende Tracking-Informationen, der Verlust der Einstellungen der zulässigen Methoden beim Wechsel von API-Typen, übermäßige Anfragen, die Quotenbegrenzungen riskieren, und mangelnder Schutz vor „429“-Quotenbegrenzungsfehlern. Durch Überschreiten des Kontingents wurde verhindert, dass Versandraten für Kunden angezeigt wurden.
Die Integration der USPS REST-API wurde verbessert, um:
- Geben Sie die richtigen Tracking-Informationen für versendete Pakete an.
- Beibehalten der Einstellungen der zulässigen Methoden beim Wechsel zwischen USPS WEBtools und REST APIs.
- Vermeiden Sie unnötige Anfragen an die USPS-API und reduzieren Sie so das Risiko, die Quotenbegrenzungen zu erreichen.
- Behandeln Sie Fehler beim Kontingent-Limit „429“ kontrolliert und stellen Sie sicher, dass die Versandraten für Kunden verfügbar bleiben.

_AC-16577 - [GitHub-Problem](https://github.com/magento/magento2/issues/40394) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/15a9362d)_
...
#### Die Versandmethode der USPS-Rest-API wird für einige Produkte nicht an der Kasse angezeigt

USPS REST API Versandmethoden sind jetzt für Produkte in der Kasse verfügbar.

_ACP2E-4556 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/aa2e16d1)_
...
Es wurde ein Problem behoben, bei dem Änderungen an Katalogpreisregeln über Staging-Aktualisierungen nicht konsistent im Warenkorb widergespiegelt wurden. Nach dieser Fehlerbehebung werden bei Anwendung einer geplanten Preisregel-Aktualisierung die Produktpreise in allen Warenkorbabschnitten (zentraler Block und Zusammenfassungsblock) korrekt aktualisiert.

_AC-16530 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/57bad413)_
...
Vor der Korrektur konnten Gutschein-Codes im Staging-Vorschaumodus nicht ordnungsgemäß verwendet werden. Nach der Fehlerbehebung werden Gutschein-Codes jetzt ordnungsgemäß auf die Kaufbestätigungsseite angewendet.
...
#### Problem mit der Sonderpreisplanung

Vor der Fehlerbehebung wurde der Sonderpreis ab dem Datum nicht ordnungsgemäß gespeichert, wenn eine aktualisierte Staging-Umgebung gespeichert wurde. Jetzt, nach der Fehlerbehebung, werden die entsprechenden Sonderpreise von/bis mit den Start- und Enddaten der Staging-Aktualisierung korreliert.

_ACP2E-4433 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/f2fd9628)_
...
Die Konvertierung des dynamischen Bundle-Produktpreises ohne Steuerberechnung für den Angebotsposten funktioniert ordnungsgemäß.

_ACP2E-4411 - [GitHub-Code-Beitrag](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problem] SwiftOtter-SOP-348 Kompilierten Konfigurations-Cache für die Testausführung aktivieren

Verbessert die Leistung der Integrationstests, indem der compiled_config-Cache während der Testausführung aktiviert wird, wodurch die CPU-Nutzung und die Ausführungszeit reduziert werden.

_AC-16018 - [GitHub-Problem](https://github.com/magento/magento2/issues/40253) - [GitHub-Code-Beitrag](https://github.com/magento/magento2/pull/40239)_
