...
---
# Versionshinweise zu Magento Open Source (v2.4.8-beta2)

## Highlights in v2.4.8-beta2

Die folgenden 30 Highlights gelten für die Version 2.4.8 von Magento Open Source.

### Braintree

* _BUNDLE-3400_: Nicht unterstützte LPMs entfernen
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3401_: Google Pay Mark
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3402_: Apple Pay Mark
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3403_: Google Pay-Versand-Rückruf
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3404_: Später bezahlen
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3405_: Schaltfläche JS-SDK
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3406_: Code innerhalb der Braintree-Erweiterung optimieren
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3407_: Aktualisieren von Braintree PHP und JS SDK
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3408_: Zeileneinträge (GooglePay)
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3409_: Zeileneinträge (Apple Pay)
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3420_: Paketverfolgung
   * _GitHub-Code-Beitrag_: <https://github.com/magento/ext-braintree/pull/208>

### Framework

* _AC-12012_: Nginx-Version von 1.24 auf 1.26 aktualisieren
* _AC-12028_: Hinzufügen der Kompatibilität mit der neuesten Composer 2.8-Version für 2.4.8 und 2.4.7
* _AC-12029_: Kompatibilität mit Lack 7.6 prüfen
* _AC-12970_: PHPUnit 10 Upgrade Teil 2 - Entfernen von veralteten Versionen
...
* _AC-13076_: Aktualisieren aller js-Bibliotheks- und npm-Abhängigkeiten mit der neuesten verfügbaren Version
...
* _AC-13077_: Alle gebündelten Erweiterungen und integrierten Komponenten sind mit PHP 8.4 kompatibel
* _AC-13078_: Alle Adobe Commerce-Tools sind mit PHP 8.4 kompatibel
* _AC-13079_: Alle Adobe Commerce-Projektlaminas/-abhängigkeiten sind mit PHP 8.4 kompatibel
* _AC-13256_: Herunterstufen der TinyMCE-Abhängigkeit von Version 7 auf Version 6.8.5
* _AC-13276_: Die Einstellung von PHP 8.4 erfordert grundlegende Änderungen an Adobe Commerce
* _AC-8828_: Standardsortierung für MySQL auf utf8mb4 festlegen

### Sonstige

* _AC-12133_: Adobe Commerce 2.4.8 Kerncode ist kompatibel mit PHP 8.4
* _AC-12972_: 2.4.8-beta2 Verbesserungen der Kernqualität
* _AC-13038_: Entfernen PHP 8.1 von composer.json und alle damit verbundenen Unterstützung
...
* _AC-10982_: [2FA] Integration mit Duo Web SDK zur Unterstützung der universellen Eingabeaufforderung
   * _Hinweis:_ wird noch bekannt gegeben

### Test-Framework

* _AC-9037_: Möglichkeit, das Adobe-Copyright für den Adobe Commerce-Quellcode zu verwenden

### UI-Framework

* _AC-12944_: TinyMCE 5 aus Adobe Commerce entfernen

## Behobene Probleme in v2.4.8-beta2

Im Magento Open Source 2.4.8-Kerncode wurden 159 Probleme behoben. Nachfolgend werden einige der in dieser Version enthaltenen behobenen Probleme beschrieben.
