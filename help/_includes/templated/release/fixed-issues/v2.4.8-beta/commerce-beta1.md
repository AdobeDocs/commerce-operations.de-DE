...
* _AC-12882_:
   * _Fehlerbehebung_: Überprüfen des Integrations-Builds nach dem Komponenten-Upgrade
   * _GitHub-Problem_: &lt;<https://github.com/magento/magento2/commit/b34c0a75>>
...
* _AC-8089_
   * _Fix Hinweis_: Untersuchen Sie die Abhängigkeiten von League/Flysystem Composer, die auf die neueste Version aktualisieren
...
* _LYNX-526_: GraphQL. Konfiguration wird für „Bestellung abbrechen“ der verfügbaren Aktionen nicht berücksichtigt
