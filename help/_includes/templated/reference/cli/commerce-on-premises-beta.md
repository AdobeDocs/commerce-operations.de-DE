...
Erstellen Sie einen benutzerdefinierten Ereignisanbieter in Adobe I/O Events für diese Instanz. Wenn Sie die Beschriftungs- und Beschreibungsoptionen nicht angeben, müssen diese in der Datei app/etc/event-types.json des Systems definiert werden.
...
Führen Sie die erneute Übermittlung von Feed-Daten nur an den SaaS-Dienst aus. Indexiert nicht neu.
...
Feed-Name zur vollständigen erneuten Synchronisierung mit dem SaaS-Dienst. Verfügbare Feeds:

- Erfordert einen Wert

### `--cleanup-feed`

Bereinigen der Feed-Indexertabelle vor der Synchronisierung erzwingen
