...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Veröffentlicht <a href="https://experienceleague.adobe.com/docs/commerce-operations/tools/quality-patches-tool/release-notes.html">Versionshinweise</a> für die Paketversion 1.1.40 Quality Patches Tool (QPT) .</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Es wurden Informationen zum Aktivieren des PHP Application Servers für GraphQL-APIs in einer Cloud Starter-Umgebung hinzugefügt. Siehe <a href="https://experienceleague.adobe.com/docs/commerce-operations/performance-best-practices/performance-best-practices/application-server.html">Anwendungsserver für GraphQL-APIs</a>.</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Veröffentlicht <a href="https://experienceleague.adobe.com/docs/commerce-operations/tools/quality-patches-tool/release-notes.html">Versionshinweise</a> für die Paketversion 1.1.39 Quality Patches Tool (QPT) .</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p>Die <a href="https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/system-requirements.html">Systemanforderungen</a> für Patches, die im Oktober 2023 veröffentlicht wurden.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Eine Beschreibung der neuen <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/cache/configure-varnish-commerce.html">Handles params size</a> Systemkonfigurationsoption für das vollständige Caching.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Klarere Anforderungen für die Verwendung der <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/cli/configuration-management/set-configuration-values.html">Umfang</a>, <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/multi-sites/ms-admin.html">Website-, Store- und Store-Ansicht</a> Codes.</p>
</td>
      <td>major-update</td>
