...
Dadurch werden die 10 größten Tabellen angezeigt. Erhöhen Sie die `LIMIT`, wenn weitere Tabellen angezeigt werden sollen. Ohne Beschränkung zeigt der Befehl alle vorhandenen Tabellen (über 100) an. Außerdem wird die Größe der einzelnen Tabellen angezeigt. Sie können die Liste überprüfen und festlegen, welche Tabellen Aufmerksamkeit auf der Grundlage ihrer Größe erfordern.