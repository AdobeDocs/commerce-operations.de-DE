...
Weitere Informationen zum Installieren dieses Tools in Ihrem Projekt finden Sie im [Installationshandbuch für das Site-weite Analyse-Tool](https://experienceleague.adobe.com/docs/commerce-operations/tools/site-wide-analysis-tool/installation.html){target="_blank"} .
...
Adobe Commerce bietet eine gute Anleitung zum Ausführen von Komponententests. Weitere Informationen finden Sie unter [PHP-Komponententests](https://developer.adobe.com/commerce/testing/guide/unit/){target="_blank"} im _Leitfaden zum Anwendungstest_ auf der Adobe Developer-Dokumentations-Site.
