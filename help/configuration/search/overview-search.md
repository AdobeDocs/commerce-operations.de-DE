...
description: Erfahren Sie mehr über die Katalogsuche in Elasticsearch und OpenSearch für Adobe Commerce, Voraussetzungen, Webserver-Setup und Wartungsaufgaben nach der Installation.
...
Ab Version 2.4.4 benötigt Adobe Commerce entweder [Elasticsearch](https://www.elastic.co) oder [OpenSearch](https://opensearch.org/docs/latest/opensearch/install/index/) als Katalogsuchmaschine. Für frühere Versionen von 2.4.x war Elasticsearch erforderlich. In den folgenden Themen finden Sie Einzelheiten zur Installation einer Suchmaschine und zur Erstkonfiguration:
