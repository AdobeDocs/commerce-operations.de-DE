...
description: Informationen zum [!UICONTROL MySQL] Tab von [!DNL Observation for Adobe Commerce].
...
Selbst `SELECT` -Anweisungen können Zeilen sperren, wenn sie mit FÜR UPDATE verwendet werden.
...
Die **[!UICONTROL Cron table change]** frame sucht nach Fehlermeldungen, die &quot;konnte keine Sperre für Cron-Auftrag erlangen:&quot;zusammen mit einem bestimmten PHP-Speicherfehler und Schlössern, die die `cron_schedule` Tabelle. Wenn die Variable `cron_schedule` -Tabelle gesperrt ist (beispielsweise durch eine `DELETE` -Abfrage ausgeführt wird), wird die Ausführung anderer Crons blockiert.
...
* &#39;%Error_code: 114%&#39;) as &#39;sql_1114_full&#39;%CRITICAL: SQLSTATE[HY000] [2006] MySQL Server ist weg%&#39;) als &#39;sql_away&#39;
...
Die **[!UICONTROL MySQL Non-Sleeping Threads by Node]** frame zeigt die Verbindungs-Threads zur Datenbank. Dieser Frame zeigt die aktiven Threads an.
