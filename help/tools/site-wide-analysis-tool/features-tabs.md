...
**[!UICONTROL Alerts]**: Auf der Seite [!UICONTROL Alerts] wird die neueste [!DNL NewRelic Managed Alerts] für die Adobe Commerce-Instanz angezeigt. Weitere Informationen zu [Managed Warnhinweisen für Adobe Commerce](/help/tools/managed-alerts-for-adobe-commerce/managed-alerts-for-magento-commerce.md) und zum [Zugriff auf NewRelic-](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/faq/access-new-relic-services)) finden Sie in der Wissensdatenbank zum Adobe Commerce-Support.

**[!UICONTROL Patches]**: Auf der Seite [!UICONTROL Patches] werden alle aktuellen Patches aus dem [[!DNL Quality Patches Tool] angezeigt: Suchen nach Patches](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html){target="_blank"} die mit der Adobe Commerce-Instanzversion des Händlers kompatibel sind. Weitere Informationen zum [[!DNL Quality Patches Tool]: Ein Self-Service-Tool für hochwertige Patches finden &#x200B;](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) im Tools-Handbuch.
