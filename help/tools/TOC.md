...
- Site-Wide Analysis Tool {#site-wide-analysis-tool}
  ...
  - [SWAT-Gesundheitsindex-Bewertung](site-wide-analysis-tool/swat-health-index.md)
...
- Quality Patches Tool {#quality-patches-tool}
  ...
  - Im Quality Patches Tool verfügbare Patches {#patches-available-in-qpt}
    ...
    - v1.1.13 {#v1-1-13}
      ...
      - [MDVA-44188: E-Mails werden nicht an IDs gesendet, die &quot;.-&quot; enthalten](quality-patches-tool/patches-available-in-qpt/v1-1-13/mdva-44188-emails-are-not-sent.md)
    - v1.1.14 {#v1-1-14}
    ...
    - v1.1.50 {#v1-1-50}
      ...
      - [ACSD-46938: Leistungsprobleme mit DB-Triggern beim Setup:upgrade](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-46938-fix-for-db-triggers-performance-issue-during-setup-upgrade.md)
    ...
    - v1.1.55 {#v1-1-55}
      ...
      - [ACSD-61534: Die Design-Konfiguration kann nicht mit der bin/magento-Konfiguration festgelegt werden:set](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-55/acsd-61534-design-configuration-cannot-set-using-bin-magento-config-set.md)
    ...
    - v1.1.67 {#v1-1-67}
      ...
      - [ACSD-65935: Die GraphQL-Abfrage customerOrders gab einen internen Server-Fehler zurück, als ein Produkt gelöscht wurde](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-65935-customerorders-graphql-query-returned-an-internal-server-error-when-a-product-was-deleted.md)
    ...
    - v1.1.70 {#v1-1-70}
      ...
      - [ACSD-67030: Die Zuweisung einfacher Produkte wird aufgehoben, wenn ein konfigurierbares Produkt von einem Administrator mit eingeschränkter Rolle bearbeitet wird](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-67030.md)
      ...
      - [ACSD-66120: [!DNL GraphQL] zeigt falsche Rabattprozentsätze und Grundpreise an, wenn Katalogpreise Steuern enthalten](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-66120.md)
      ...
      - [AC-15210: Migration der USPS-Integration von den Web-Tools-APIs zu den neuen RESTful-USPS-APIs](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/ac-15210.md)
    - v1.1.71 {#v1-1-71}
      - [Übersicht: [!DNL Quality Patches Tool] (QPT) v1.1.71](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/overview.md)
      - [ACSD-67089: Die API Inventory/export-stock-salable-quantity gibt bei festgelegter page_size eine falsche total_count zurück](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67089.md)
      ...
      - [ACSD-67093: Beim Abrufen von Bestellungen über GraphQL mithilfe des Datumsbereichsfilters werden falsche Ergebnisse zurückgegeben](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67093.md)
      - [ACSD-67652: Bundle-Produktstatus, der in GraphQL-Aufrufen mit untergeordneten und übergeordneten Produkten als nicht vorrätig zurückgegeben wird](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67652.md)
    ...
    - v1.1.72 {#v1-1-72}
      ...
      - [ACSD-68118: customerCart [!DNL GraphQL] query gibt falsche Produktattributwerte für die Store-Ansicht zurück](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68118.md)
      - [ACSD-66807: Die Tabelle report_viewed_product_index zeigt eine falsche Anzahl von Produktseitenansichten an](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-66807.md)
      - [ACSD-68040: Frontend-Suchseite verlangsamt on [!DNL MariaDB] 10.6 mit großem Verlauf](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68040.md)
      - [ACSD-67639: Das Erstellen einer Gutschrift schlägt für Bundle-Produkte fehl, deren dynamischer Preis auf „Nein“ gesetzt ist.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67639.md)
      - [ACSD-67518:  [!DNL Advanced Reporting]  doppelte Kopfzeilen, wenn die Zeilenanzahl die Batch-Größe überschreitet](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67518.md)
      - [ACSD-67941: GraphQL-Anfragen mit unbekannten Filternamen verursachen PHP-Ausnahmeprotokolle](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67941.md)
      - [ACSD-68011: Nicht vorhandene SKUs, die über die API /V1/sharedCatalog/:id/assignProducts dem freigegebenen Katalog zugewiesen sind](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68011.md)
      - [ACSD-68092: Bundle-Produktoptionen gehen nach mehreren Speichervorgängen verloren](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68092.md)
      - [ACSD-67187: Administratorbenutzer, die auf nicht standardmäßige Websites beschränkt sind, erhalten den Fehler „Erstellen Sie mindestens einen öffentlichen freigegebenen Katalog, um fortzufahren“](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67187.md)
    ...
    - v1.1.74 {#v1-1-74}
      ...
      - [ACSD-68499: Die Mutation &quot;GraphQL updateCartItems“ gibt Erfolg für Mengen zurück, die über den verfügbaren Bestand hinausgehen](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68499.md)
      - [ACSD-68810: Bestellung, die einem Kunden zugewiesen wurde, der trotz Konfiguration der Kontofreigabe auf einer anderen Website erstellt wurde](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68810.md)
      - [ACSD-68430: Das Speichern eines Kunden oder einer Adresse schlägt fehl, wenn der Datensatz mehrere gelöschte Attributoptionen enthält](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68430.md)
      - [ACSD-68636: Name des Geschäftsinhabers fehlt in den E-Mail-Kopfzeilen der Geschenkkarte, wenn die Rechnung in einem anderen Geschäft erstellt wird](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68636.md)
    - v1.1.75 {#v1-1-75}
      - [Übersicht: [!DNL Quality Patches Tool] (QPT) v1.1.75](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/overview.md)
      - [ACSD-68359: Behebt 414-Fehler bei der Auswahl von [!UICONTROL Pick in Store] mit großen Warenkörben](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68359.md)
      - [ACSD-68517: Behebt einen Fehler bei der erneuten Übermittlung von Formularen auf [!UICONTROL Catalog]- und [!UICONTROL Catalog Search]](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68517.md)
      - [ACSD-68573: Kategorieberechtigungen wurden nicht auf Elemente der Kunden-Wunschliste angewendet, was zu einer falschen Anzeige und Paginierung in der Web-Storefront und in GraphQL führte](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68573.md)
      - [ACSD-68793: Gültige Produkte werden bei der freigegebenen Katalogzuweisung fälschlicherweise abgelehnt](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68793.md)
      - [ACSD-68925: GraphQL-Antworten folgen jetzt HTTP-Spezifikationen und geben 4XX für nicht analysierbare, nicht autorisierte oder ungültige Anfragen zurück](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68925.md)
      - [ACSD-68289: Volltextsuche gibt keine Ergebnisse zurück, wenn die Mindestübereinstimmung für alle durchsuchbaren Felder gilt](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68289.md)
      - [ACSD-68451: Firmenadministratorlinks zu einem nicht verbundenen Unternehmen über mehrere Websites hinweg](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68451.md)
      - [ACSD-68615: CLI-Ausnahme für Ausgleichszahlungen für Lagerreservierungen für fehlende Auftrags-ID](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68615.md)
      - [ACSD-68490: [!UICONTROL Add New Attribute] Schaltfläche für Administratoren mit eingeschränkter Administratorberechtigung während der konfigurierbaren Produkterstellung sichtbar](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68490.md)
    - v1.1.76 {#v1-1-76}
      - [Übersicht: [!DNL Quality Patches Tool] (QPT) v1.1.76](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/overview.md)
      - [ACSD-69319: Die Preise für gebündelte Produkte wurden nicht richtig indiziert, wenn untergeordnete Produkte unter Zollquellen vorrätig waren](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69319.md)
      - [ACSD-69086: Installation schlägt auf MariaDB 10.11 aufgrund einer nicht unterstützten Datenbankversionsprüfung fehl](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69086.md)
      - [ACSD-69331: Die Erstellung des Mediensammlungs-Ordners schlägt für Admin-Benutzende mit der Berechtigung Nur Ordner erstellen fehl](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69331.md)
      - [ACSD-69203: Das Produktlisten-Widget gibt falsche Ergebnisse zurück, wenn mehrere Kategorien in der Kategoriebedingung verwendet werden](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69203.md)
      - [ACSD-69115: Warenkorbfehler werden Admin-Benutzern nicht für Kunden angezeigt, die nicht-standardmäßigen Websites zugewiesen wurden](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69115.md)
      - [ACSD-67370: Falsche Preise wurden für Bundle Produkte auf PDP/PLP und der Warenkorbseite für mehrere Währungen angezeigt](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-67370.md)
      - [ACSD-69261: Einmalige Warenkorb-Preisregel-Coupon wird aufgrund falscher time_used-Handhabung in Teilrechnungs- und Stornierungsflüssen wiederverwendet](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69261.md)
      - [ACSD-67091: Die Bereinigung des Katalogregelproduktindex schlägt aufgrund der maximalen Größe des Writesets bei großen Löschungen fehl](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-67091.md)
      - [ACSD-69308: Regeln für Katalogpreise gelten nicht, wenn „special_price“ auf Website-Ebene festgelegt wird](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69308.md)
      - [ACSD-69541: ACSD-69541: Die Artikelmenge im Warenkorb kann nicht über GraphQL aktualisiert werden, nachdem der Produktbestand in [!UICONTROL Admin] reduziert wurde](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69541.md)
      - [ACSD-69325: Durch Änderung des SKU-Falls erscheint das Produkt nicht mehr vorrätig in der Storefront](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69325.md)
      - [Die Aktualisierung der ACSD-69129: [!DNL REST] API-Stufe schlägt fehl, nachdem die standardmäßige Basis-Website gelöscht und die sekundäre Website als Standard verwendet wurde](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69129.md)
      - [ACSD-68410: Der verhandelbare Preis-Checkout umfasst unbeabsichtigte Artikel im Warenkorb](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-68410.md)
      - [ACSD-69333: SKU-Änderungen für Produkte mit einer aktiven geplanten Aktualisierung zulässig](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69333.md)
    - v1.1.77 {#v1-1-77}
      - [Übersicht: [!DNL Quality Patches Tool] (QPT) v1.1.77](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/overview.md)
      - [ACSD-69237: sales_*_async_insert cron jobs verarbeitet nur 100 Einträge pro Durchgang](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69237.md)
      - [ACSD-68759: Die Erstellung eines Kundenkontos schlägt mit dem Gebietsschema Arabisch (Saudi-Arabien) fehl, wenn [!UICONTROL Date of Birth] in der Storefront sichtbar ist](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68759.md)
      - [ACSD-69016: Sonderpreise gelten nicht für Websites mit unterschiedlichen Zeitzonen](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69016.md)
      - [ACSD-69351: Guthaben und Ablaufdaten der Geschenkkarte werden auf falschen Websites angezeigt](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69351.md)
      - [ACSD-69020: Konfigurierbare Produkte werden in  [!DNL Page Builder]  angezeigt, wenn untergeordnete Produkte mit Filtern übereinstimmen](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69020.md)
      - [ACSD-68892: Inkonsistentes  [!DNL Fastly]  für zwischenspeicherbare Seiten](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68892.md)
      - [ACSD-68664: Die Vorschau des geplanten Updates enthält Fehler bei benutzerdefinierten Store-Domains](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68664.md)
      - [ACSD-63687: Aufgrund von Cache [!DNL Redis] Bereinigungsproblemen werden falsche Preise angezeigt](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-63687.md)
      - [ACSD-69494: Async-Erstattungsanfragen mit „is_online“-dont Trigger Online-Erstattungen](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69494.md)
      - [ACSD-68537: Die Kaufleistung verschlechtert sich mit vielen Kundensegmenten](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68537.md)
      - [ACSD-69311: Falsche Steuerberechnung in Gutschriften nach Teilerstattungen aus Rechnungen](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69311.md)
    ...
    - v1.1.78 {#v1-1-78}
      ...
      - [ACP2E-4591: Kundensegmente, die auf der Bestellanzahl basieren, wie z. B. „Erstkäufer“, werden nicht aktualisiert, wenn Bestellungen über die REST-API aufgegeben werden](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4591.md)
      - [ACP2E-4732: Die partielle Indizierung stoppt für Kunden mit vielen Updates, wenn die Spalte version_id in der Changelog-Tabelle ihren Höchstwert erreicht](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4732.md)
      - [ACP2E-4456: Durch Stornieren einer Bestellung mit einer GraphQL-Mutation werden Bestellungen, die vollständig mit Geschenkkarten bezahlt wurden, nicht in den Status „Geschlossen“ verschoben](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4456.md)
      - [ACP2E-4452: Schnellbestellseite Die Produktpreise enthalten die Steuer unabhängig von der Konfiguration der Steueranzeige](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4452.md)
      - [ACP2E-4448: Konfigurationsänderungen, die während  [!DNL Redis] -Ausfällen vorgenommen wurden, werden nach  [!DNL Redis]  Wiederherstellung nicht widergespiegelt und veraltete Werte bleiben erhalten](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4448.md)
      - [ACP2E-4665: Untergeordnete Produkte von konfigurierbaren Produkten mit Videos in den Produktgalerien werden nicht angezeigt, wenn sie über die REST-API angefordert werden](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4665.md)
      - [ACP2E-4613: Großes Medienverzeichnis führt zu Verzögerungen beim Laden der Media Gallery-Verzeichnisstruktur](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4613.md)
      - [ACP2E-4609: Die [!UICONTROL My Quotes] Seite zeigt keine Anführungszeichen an, wenn einige Anführungszeichen gelöschte Produkte enthalten](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4609.md)
      - [ACP2E-4416: Kundenprämienpunkte werden nicht initialisiert, wenn sie in der Admin erstellt werden](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4416.md)
      - [ACP2E-4535: Senden des Formulars für vergessenes Passwort zerstört oder regeneriert die Sitzung (PHPSESSID-Änderungen) und löscht den Gästekorb](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4535.md)
      - [ACP2E-4507: Die [!UICONTROL Password Options]-Konfiguration gilt nicht für Anfragen zum Zurücksetzen von Kundenkennwörtern, die über GraphQL-Mutationen vorgenommen wurden](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4507.md)
      - [ACP2E-4431: [!UICONTROL Related Products], denen Zielregeln zugeordnet sind, werden während des Neuindizierungsprozesses gelöscht](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4431.md)
      - [ACP2E-4540: Die Fotorama-Bibliothek wird nicht korrekt geladen, sodass nur das erste angehängte Bild sichtbar ist](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4540.md)
      - [ACP2E-4555: Telefonnummern, die Punkte oder Schrägstriche enthalten, werden nicht ordnungsgemäß validiert](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4555.md)
      - [ACP2E-4565: Die Abfrage von Company GraphQL gibt „Der aktuelle Kunde ist nicht autorisiert“ zurück, wenn der Header X-Adobe-Company verwendet wird](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4565.md)
      - [ACP2E-4522: Zeitweise treten doppelte Schlüsselfehler in der Tabelle quote_coupons auf, wenn mehrere Anfragen zum Zusammenführen des Warenkorbs oder zum Speichern von Angeboten gleichzeitig ausgeführt werden](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4522.md)
    ...
    - v1.1.79 {#v1-1-79}
      ...
      - [ACP2E-4531: Die CMS-Hierarchie aktualisiert die hierarchische URL nicht, wenn sich der URL-Schlüssel der untergeordneten Seite ändert](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4531.md)
      ...
      - [AC-10737: `bin/magento setup:db:status` Befehl erkennt den JSON-Datentyp nicht](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/ac-10737.md)
    ...
    - v1.1.80 {#v1-1-80}
      ...
      - [ACP2E-4493: Das Raster „Kundenauftragsarchiv“ zeigt bei aktivierter asynchroner Indizierung einen falschen Bestellstatus an](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4493.md) - [ACP2E-4239: Admin-Raster-Datumsfilter geben keine Ergebnisse aufgrund von nicht übereinstimmender Zeitzone zurück](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4239.md)
      ...
      - [ACP2E-4610: Langsame Ausführung von `sales_clean_quotes` Cron](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4610.md)
      ...
      - [ACP2E-4552: GraphQL-Antwort gibt den Unternehmensstatus nicht zurück](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4552.md)
      - [ACP2E-4496: Analytics-Cron-Auftrag verschlechtert Leistung während der Ausführung](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4496.md)
      - [ACP2E-4488: Langsames Speichern/Bearbeiten von Admin-Produkten für große Attributsätze](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4488.md)
      - [ACP2E-4653: Bedingungen für den Kategoriebereich der Warenkorbpreise fehlen in  [!DNL REST] API](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4653.md)
      - [ACP2E-4472: Null-Zitat, das mit der Anmeldung als Kundenfluss erstellt wurde](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4472.md)
      - [ACP2E-4808: Produktgewichtsanzeigen ohne Maßeinheit auf Storefront](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4808.md)
    ...
    - v1.1.82 {#v1-1-82}
      ...
      - [ACP2E-4799: Abfrage-Anforderungslisten von GraphQL geben falsche total_count mit Paginierung zurück](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4799.md)
      - [ACP2E-4797: Admin-WYSIWYG-Editor und Page Builder blockieren 4-Byte-Unicode-Zeichen, wenn utf8mb4 unterstützt wird](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4797.md)
      - [ACP2E-4682: Storefront-Seiten, die Zitate überprüfen, sind aktiv, erstellen leere Zitateinträge](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4682.md)
...
- Datenmigrations-Tool {#data-migration}
  ...
  - Ressourcen {#resources}
    - [Fehlerbehebung](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/data-migration-tool-troubleshooting)
