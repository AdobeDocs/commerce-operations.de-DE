...
* **ACSD-53925** (für Adobe Commerce und Magento Open Source >=2.4.2 &lt;2.4.7) - Behebung des Problems, bei dem der Administrator den CMS-Block nicht mit dem Produktkarussell speichern kann, wenn `catalog_product_price` dimensions-mode auf *website* eingestellt ist.
...
* **ACSD-54983** (für Adobe Commerce >=2.4.2 &lt;2.4.7) - Behebung des Problems, bei dem das Abrufen der Benutzer-UID des Unternehmens mit GraphQL-Anfrage nicht möglich ist, wenn der Benutzerstatus auf *[!UICONTROL Inactive]* festgelegt ist.
