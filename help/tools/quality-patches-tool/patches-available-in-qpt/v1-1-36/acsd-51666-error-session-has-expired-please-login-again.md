...
Der Patch von ACSD-51666 behebt das Problem, dass der Fehler *Die Sitzung ist abgelaufen, bitte melden Sie sich erneut an.* Tritt nach dem Anmeldeversuch auf. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.36 installiert ist. Die Patch-ID ist ACSD-51666. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.7 behoben wird.
