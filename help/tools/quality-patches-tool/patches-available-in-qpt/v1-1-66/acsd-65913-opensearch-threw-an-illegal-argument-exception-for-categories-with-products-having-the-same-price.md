...
[!DNL OpenSearch] löst beim Laden von Kategorien, in *[alle Produkte denselben Preis hatten, einen `illegal_argument_exception` aus] (Parameter darf nicht negativ sein*.
