...
Der Patch MDVA-26005 löst das Problem, dass Benutzende keine Kategorie in der Kategoriestruktur für Warenkorbpreisregelbedingungen auswählen können. Dieser Patch ist verfügbar, wenn das [Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.4 installiert ist. Die Patch-ID lautet MDVA-26005. Beachten Sie, dass das Problem in Adobe Commerce 2.3.6 behoben wurde.
