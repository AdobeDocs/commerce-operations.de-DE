...
Die Mediensammlung kann aufgrund eines kritischen Fehlers, der bei der `var/log/system.log` protokolliert wurde, keine Bilder aus dem `wysiwyg` Verzeichnis laden:
