...
Der Patch von ACSD-53643 behebt das Problem, dass die Bestellung eine falsche Summe aufweist, wenn eine Bestellung mit deaktivierten oder nicht vorrätigen Produkten aufgegeben wird. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.41 installiert ist. Die Patch-ID ist ACSD-53643. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.7 behoben wird.
...
1. Erstellen Sie *Genehmigungsregel* um alle Bestellungen mit mehr als *1 USD* durch den Unternehmensadministrator zu genehmigen.
