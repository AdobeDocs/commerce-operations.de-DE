...
1. Melden Sie sich beim Frontend an und gehen Sie über das obere Menü oder über **[!UICONTROL My Requisition Lists]** zu **[!UICONTROL My Account]** und erstellen Sie mehrere Anforderungen (Beispiel: 7).
