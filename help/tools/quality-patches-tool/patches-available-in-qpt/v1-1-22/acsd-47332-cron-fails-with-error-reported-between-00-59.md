...
Der Patch ACSD-47332 behebt das Problem, dass cron mit einem Fehler fehlschlägt, der nur gemeldet wird, wenn er zwischen 00:00:00UTC :59. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.22 installiert ist. Die Patch-ID ist ACSD-47332. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.6 behoben wird.
