...
Der Patch MDVA-40120 löst das Problem, dass die Sortierung von GraphQL nach DESC/ASC bei Produkten mit gleicher Relevanz oder demselben Preis nicht funktioniert. Dieser Patch ist verfügbar, wenn das [Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.6 installiert ist. Die Patch-ID lautet MDVA-40120. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.4 behoben wird.
