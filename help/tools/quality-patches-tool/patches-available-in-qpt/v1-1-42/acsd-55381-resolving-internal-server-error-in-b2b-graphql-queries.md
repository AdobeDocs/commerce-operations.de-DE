...
Mit dem Patch ACSD-55381 wird das Problem behoben, dass bei GraphQL-Abfragen von `configurable_product_option_uid`- und `configurable_product_option_value_uid` aus einer B2B-Anforderungsliste ein interner Server-Fehler auftritt. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42 installiert ist. Die Patch-ID ist ACSD-55381. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.7 behoben wird.
