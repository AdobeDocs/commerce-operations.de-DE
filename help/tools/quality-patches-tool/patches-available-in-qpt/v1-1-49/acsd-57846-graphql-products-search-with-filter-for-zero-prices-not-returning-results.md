...
Mit dem Patch ACSD-57846 wird das Problem behoben, dass das Filtern von Produkten nach einem Preis von null zu einer fehlerhaften Anfrage an [!DNL OpenSearch] führt und keine Ergebnisse zurückgibt. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49 installiert ist. Die Patch-ID ist ACSD-57846. Beachten Sie, dass das Problem in Adobe Commerce 2.4.7 behoben wurde.
