...
Mit dem Patch ACSD-57941 wird das Problem behoben, dass die Produktoptionen fälschlicherweise dem Admin Store anstelle den jeweiligen Stores zugewiesen werden. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49 installiert ist. Die Patch-ID ist ACSD-57941. Beachten Sie, dass das Problem in Adobe Commerce 2.4.7 behoben wurde.
