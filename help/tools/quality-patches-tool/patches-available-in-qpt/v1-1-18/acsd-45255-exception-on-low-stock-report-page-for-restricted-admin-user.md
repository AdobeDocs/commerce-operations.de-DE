...
Der Patch ACSD-45255 löst das Problem, dass auf der Seite „Low Stock Report“ eine Ausnahme für einen Benutzer mit eingeschränktem Administratorzugriff ausgelöst wird. Dieser Patch ist verfügbar, wenn das [Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.18 installiert ist. Die Patch-ID ist ACSD-45255. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.6 behoben wird.
