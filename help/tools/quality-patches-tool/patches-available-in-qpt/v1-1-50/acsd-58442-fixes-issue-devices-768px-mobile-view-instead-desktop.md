...
Mit dem Patch ACSD-58442 wird das Adobe Commerce-Problem behoben, bei dem Geräte mit einer Breite von 768 Pixel als Mobilgeräte behandelt werden, sodass das Menü und die Kopfzeile in einer Mobilansicht anstelle eines Desktops geladen werden. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.50 installiert ist. Die Patch-ID ist ACSD-58442. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.8 behoben wird.
