...
Der Patch MDVA-40619 löst das Problem, dass die CMS-Seitenhierarchieänderungen die CMS-Seite inline bearbeiten und einen „500-Fehler“ auslösen. Dieser Patch ist verfügbar, wenn das [Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.5 installiert ist. Die Patch-ID lautet MDVA-40619. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.4 behoben wird.
