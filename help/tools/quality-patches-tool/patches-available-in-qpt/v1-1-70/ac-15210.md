...
Aktualisieren Sie nach der Installation des Patches die Konfiguration des Commerce USPS Shipping Carriers , um sie in die neuen USPS-APIs zu integrieren. Anweisungen finden Sie unter dem Thema [USPS Web Tools - &#x200B;](https://experienceleague.adobe.com/de/docs/commerce-admin/stores-sales/delivery/shipping-carriers/carriers#usps-web-tools-api-deprecation) im Handbuch *Stores and Purchases*.
