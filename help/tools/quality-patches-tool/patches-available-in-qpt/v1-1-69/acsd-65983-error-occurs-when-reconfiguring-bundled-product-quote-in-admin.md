...
description: Wenden Sie den Patch ACSD-65983 an, um das Adobe Commerce-Problem zu beheben, bei dem beim Versuch, ein Bundle-Produkt im Bildschirm [!UICONTROL Sales] > [!UICONTROL Quotes] > [!UICONTROL Edit] am Backend zu konfigurieren, ein Fehler auftritt.
feature: B2B, Quotes
