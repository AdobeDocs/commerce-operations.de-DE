...
Mit dem Patch ACSD-53979 wird das Problem behoben, dass auf der Homepage ein JavaScript-Fehler auftritt, wenn die Begrüßungsnachricht ein einfaches Anführungszeichen enthält. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.37 installiert ist. Die Patch-ID ist ACSD-53979. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.7 behoben wird.
