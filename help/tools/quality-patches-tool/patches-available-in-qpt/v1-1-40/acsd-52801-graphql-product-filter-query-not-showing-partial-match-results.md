...
Der Patch ACSD-52801 behebt das Problem, dass die GraphQL-Produktfilterabfrage keine Ergebnisse zu teilweisen Übereinstimmungen anzeigt. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.40 installiert ist. Die Patch-ID ist ACSD-52801. Beachten Sie, dass das Problem in Adobe Commerce 2.4.7 behoben wurde.
