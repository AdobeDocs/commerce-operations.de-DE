...
Der Patch ACSD-55031 behebt das Problem, dass der `Type "mixed" cannot be nullable` während der Kompilierung nach der Installation einer benutzerdefinierten Erweiterung auftritt. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.40 installiert ist. Die Patch-ID ist ACSD-55031. Beachten Sie, dass das Problem in Adobe Commerce 2.4.6 behoben wurde.
