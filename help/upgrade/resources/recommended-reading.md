    ...
    <tr>
      <td><strong>Versionshinweise und Ankündigungen</strong>
        <p>Erfahren Sie mehr über die neuesten Entwicklungen in Adobe Commerce, einschließlich Produktstrategie, Sicherheit, Fehlerbehebungen und bekannter Probleme.</p>
          <ul>
            ...
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/overview">Adobe-Hilfezentrum</a></li>
            ...
            <li><a href="https://experienceleague.adobe.com/docs/commerce-operations/release/notes/overview.html">Versionshinweise zu Adobe Commerce in der Cloud oder lokal</a></li>
      ...
      <td><strong>Tools</strong>
        <p>Durchsuchen Sie Tools, die Ihnen das Auffinden und Verwenden der Adobe Commerce-Software erleichtern.</p>
          <ul>
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/extensibility/backend-development/upgrade/uct-phpstorm">Upgrade-Kompatibilitäts-Tool PhpStorm-Plug</a> (Video)</li>
    ...
    <tr>
      <td><strong>Kalender und Richtlinie</strong>
        <p>Überprüfen Sie Details zu Adobe Commerce-Versionen und -Richtlinien.</p>
          <ul>
            <li><a href="https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-eos-policy-faq">Häufig gestellte Fragen zum Ende der Unterstützung für Adobe Commerce-Software</a></li>
            ...
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/faq/adobe-commerce-release-strategy-lifecycle-policy">Häufig gestellte Fragen zur neuen Adobe Commerce-Versionsstrategie, aktualisierten Lebenszyklusrichtlinie und erweitertem Support</a></li>
      ...
      <td><strong>Aktualisieren von Ressourcen</strong>
        <p>Schützen Sie Ihre Storefront und arbeiten Sie effizient. Bereiten Sie sich auf Ihr Adobe Commerce-Upgrade vor, indem Sie die ausführliche technische Dokumentation zu Adobe lesen.</p>
          <ul>
            ...
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/extensibility/backend-development/upgrade/2-4-upgrade-workshop">2.4 Aufzeichnung des Workshops zur technischen Aktualisierung</a></li>
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/cannot-access-the-latest-magento-commerce-pre-release">Zugriff auf Vorabversionen</a></li>
