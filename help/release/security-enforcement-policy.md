...
Wenn Sie eine Fristverlängerung benötigen, wenden Sie sich an Ihr Account-Team oder an den [Adobe-Support](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide?lang=en#submit-ticket).
