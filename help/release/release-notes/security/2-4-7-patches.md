...
>
>Nach diesem Datum bietet Adobe Commerce 2.4.7 keine Kompatibilität mehr oder>Unterstützung für alle MySQL-Versionen, die nach MySQL 8.0 veröffentlicht wurden. Adobe nicht>Validieren oder Bereitstellen von Unterstützung für neuere MySQL-Hauptversionen auf dieser Adobe>Commerce-Release-Zeile.
>
>Bei allen Adobe Commerce On-Premise-Kunden, die Version 2.4.7 ausführen, sind die>Es wird empfohlen, die Datenbankserver auf eine kompatible MariaDB-Version zu migrieren.
...
Adobe Commerce 2.4.7-p10 führt die Kompatibilität mit MariaDB Version 11.8 ein. MariaDB 11.8 führt Änderungen im SQL-Verhalten, bei den Standardeinstellungen, bei der Einstellung und bei der Leistungsoptimierung ein. Diese Aktualisierung behandelt proaktiv potenzielle Probleme, um die Plattformstabilität und die Zukunftsbereitschaft zu gewährleisten.

#### Unterstützung der neuesten Nebenversion von OpenSearch 3

Adobe Commerce 2.4.7 unterstützt jetzt die neueste Nebenversion von OpenSearch 3 auf Adobe Commerce in Cloud-Infrastrukturen, nativen Cloud-Bereitstellungen und lokalen Bereitstellungen. Die Kompatibilität mit OpenSearch 2 bleibt erhalten.

#### Valkey 8.1 LTS-Unterstützung

Adobe Commerce 2.4.7 ist jetzt mit Valkey 8.1 LTS kompatibel und bietet eine Cache-Backend-Option mit langfristiger Unterstützung, die auf Adobe Commerce in Cloud-Infrastrukturen unterstützt wird.

#### Unterstützung von RabbitMQ 4.2

Adobe Commerce 2.4.7 ist jetzt mit RabbitMQ 4.2 kompatibel, das das für Februar 2026 geplante Ende der Unterstützung für RabbitMQ 4.1 abdeckt. Die Kompatibilität mit Apache ActiveMQ Artemis bleibt erhalten, und ActiveMQ bleibt der Standard-Warteschlangendienst für Nachrichten für diese Nur-Sicherheit-Release-Zeile.

#### USPS REST API-Unterstützung
...
Um die Einstellung der Laminas MVC zu erreichen, verwendet Adobe Commerce jetzt eine Magento-eigene Abspaltung von `laminas-mvc` (veröffentlicht als `magento/magento-zf-mvc`). Diese Abspaltung gewährleistet kontinuierliche Patches und langfristige Sicherheitskompatibilität für Adobe Commerce 2.4.7.
