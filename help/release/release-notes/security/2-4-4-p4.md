...
* **Unterstützung von Varnish Cache 7.3**. Diese Version ist mit der neuesten Version von Varnish Cache 7.3 kompatibel. Die Kompatibilität bleibt mit den Versionen 6.0.x und 7.2.x erhalten. Es wird jedoch empfohlen, Adobe Commerce 2.4.4-p4 nur mit Version 7.3 des Varnish Cache oder Version 6.0 LTS zu verwenden.

* **RabbitMQ 3.11-Unterstützung**. Diese Version ist mit der neuesten Version von RabbitMQ 3.11 kompatibel. Die Kompatibilität bleibt mit RabbitMQ 3.9 erhalten, das bis August 2023 unterstützt wird. Es wird jedoch empfohlen, Adobe Commerce 2.4.4-p4 nur mit RabbitMQ 3.11 zu verwenden.
