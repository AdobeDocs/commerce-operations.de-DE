...
3. Wenden Sie diesen Patch während des Upgrades nach der Phase Pakete verwalten und vor der Phase Metadaten aktualisieren an. Siehe [Anwenden eines Composer-Patches von Adobe](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/how-to/how-to-apply-a-composer-patch-provided-by-magento.html) .
