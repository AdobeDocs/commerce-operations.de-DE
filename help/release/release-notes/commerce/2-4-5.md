...
Die neueste Diskussion über diese behobenen Probleme [&#x200B; Sie im &#x200B;](https://helpx.adobe.com/de/security/products/magento/apsb22-38.html)Adobe-Sicherheitsbulletin.
...
* **Adressbuch** > **Kommunikation** > **Kontoinformationen** Benutzerdefinierte Fokusindikatoren bieten jetzt ein Kontrastverhältnis von mindestens 3 % :1 der Hintergrundfarbe.

<!-- AC-2486-->

* **Filter** und **Sort**-Schaltflächentext erfüllen jetzt das für WCAG 2.0 erforderliche Mindestfarbkontrastverhältnis von 4,5 :1 für Standardtext von 18 Punkt (24 Pixel) oder 14 Punkt (19 Pixel), wenn er fett gedruckt ist. Zuvor entsprachen Navigationsschaltflächen für Karussells nicht diesen minimalen Kontrastanforderungen.
...
* Trigger werden nun nach einer vollständigen Neuindizierung erwartungsgemäß in der `catalogrule_product_price` wiederhergestellt. Zuvor wurden Trigger nach einer `catalogrule_product_price` oder `catalogrule_rule` vollständigen Neuindizierung aus der `catalogrule_product` entfernt.
...
* Dem GraphQL-`price_range` wurde ein fehlendes `BundleItemOption` hinzugefügt. [GitHub-35010](https://github.com/magento/magento2/issues/35010)
...
* `price_including_tax` wurde ein `CartItemPrices` Feld hinzugefügt. [GitHub-29057](https://github.com/magento/magento2/issues/29057)
...
* Das **Nach Keyword suchen**-Eingabefeld enthält jetzt auf der Seite `aria-label`Katalog **>** Produkt **ein** statt eines Platzhalters.
