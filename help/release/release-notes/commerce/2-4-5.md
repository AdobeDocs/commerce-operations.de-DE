...
* **Adobe Commerce On-Premises-**: Adobe Commerce 2.4.5 wurde getestet und für kompatibel mit Elasticsearch 7.17 (~7.17.0 mit Einschränkung) erklärt. Händler, die Adobe Commerce lokal hosten, können entweder Elasticsearch oder OpenSearch 1.2 verwenden. <!-- AC-2425-->
