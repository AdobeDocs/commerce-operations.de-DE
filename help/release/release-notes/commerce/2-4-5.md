...
* Die PUT- und DELETE-Massenanfragen der REST-API funktionieren jetzt erwartungsgemäß, wenn das `Magento_ReCaptchaWebapiRest` aktiviert ist. [GitHub-35348](https://github.com/magento/magento2/issues/35348)
