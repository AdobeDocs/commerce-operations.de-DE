...
[Scheitelpunkt](https://experienceleague.adobe.com/de/docs/commerce-admin/stores-sales/site-store/taxes/taxes)
...
* Der Mindestpreis der Werbung **Was ist das?** Der Link auf der Warenkorbseite kann jetzt angeklickt werden und das Informations-Popup wird wie erwartet geöffnet. Zuvor hatte das Klicken auf diesen Link keine Auswirkungen.
...
* Das `composer.json`-Metapaket und die `composer.json` wurden für jedes Modul auf PHP 8.1 aktualisiert. [GitHub-34009](https://github.com/magento/magento2/issues/34009)
