...
Obwohl der Code für diese Funktionen mit vierteljährlichen Versionen des Adobe Commerce-Kerncodes gebündelt ist, werden mehrere dieser Projekte (z. B. B2B, Page Builder und Progressive Web Application (PWA) Studio) auch unabhängig voneinander veröffentlicht. Fehlerbehebungen für diese Projekte werden in den separaten, projektspezifischen Versionsinformationen dokumentiert, die in der Dokumentation für jedes Projekt verfügbar sind.
...
Adobe Commerce 2.4.4 umfasst die Lösung aller Probleme, die durch die folgenden Hotfixes behoben wurden, die für Adobe Commerce und die Magento Open Sourcen 2.4.3, 2.4.3-P1 und 2.3.7-P2 bereitgestellt wurden:
...
PWA Studio v.12.3.0 ist kompatibel mit Adobe Commerce 2.4.4. Dazu gehört die Unterstützung für reCAPTCHA, die Inhaltsoptimierung von Page Builder und personalisierte Inhalte. Weitere Informationen zu Verbesserungen und Fehlerbehebungen finden Sie unter [PWA Studio-Versionen](https://github.com/magento/pwa-studio/releases). Unter [Versionskompatibilität](https://developer.adobe.com/commerce/pwa-studio/integrations/adobe-commerce/version-compatibility/) finden Sie eine Liste der PWA Studio-Versionen und der entsprechenden kompatiblen Adobe Commerce-Kernversionen.
...
Diese Version bringt mehr Konformität mit den standardmäßigen Barrierefreiheitsrichtlinien. Diese Verbesserungen verbessern das Erlebnis von Benutzenden mit eingeschränktem Sehvermögen oder mit eingeschränkten Sprach-, kognitiven und Lernfähigkeiten.  Die Leistung von Screen Reader Tools wurde ebenfalls verbessert.
...
* Adobe Commerce entfernt jetzt wie erwartet HTML-Tags von der Storefront **Konto** > **Meine** > **Bestellung anzeigen**. Zuvor zeigte Adobe Commerce HTML-Tags im Kommentarbereich für Kundenbestellungen in der Storefront an.
...
* Adobe Commerce fügt nun der Preisindex-Zuordnung des Elasticsearchs die richtigen Preisfelder hinzu. Zuvor wurden dem Index falsche Preisfelder mit Store-ID statt Website-ID hinzugefügt.
