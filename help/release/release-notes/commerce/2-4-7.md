...
Der GraphQL-Anwendungs-Server ist nur für Adobe Commerce verfügbar. Es ist nicht für Magento Open Source verfügbar. Sie müssen [ein Adobe Commerce-Support-Ticket ](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide), um GraphQL Application Server in Pro-Projekten zu aktivieren.

>[!NOTE]
>
>Der GraphQL-Anwendungs-Server ist derzeit nicht mit [[!DNL Amazon Simple Storage Service (AWS S3)]](https://aws.amazon.com/s3/) kompatibel. Kundinnen und Kunden von Adobe Commerce auf Cloud-Infrastruktur, die derzeit [!DNL AWS S3] für [Remote-Speicher](../../../configuration/remote-storage/cloud-support.md) verwenden, können den GraphQL-Anwendungsserver erst verwenden, wenn Adobe später im Jahr 2024 einen Hotfix veröffentlicht.<!-- ACPT-1840 -->
...
Das Adobe Stock-Paket (`adobe-stock-integration`) wird jetzt im Commerce-Erweiterungsmetapaket (`extensions-metapackage`) verpackt, um häufigere Updates zu unterstützen. <!-- CABPI-630 -->

### B2B

>[!NOTE]
>
>Version 2.4.7 ist kompatibel mit B2B Version 1.4.2. Adobe Systems empfiehlt Kunden jedoch, mit einem Upgrade auf die kommende B2B GA-Version 1.5.0 zu warten, die Unterstützung für PHP 8.3 beinhaltet. Siehe [B2B Versionshinweise](https://experienceleague.adobe.com/docs/commerce-admin/b2b/release-notes.html).

### Braintree

* **[!DNL Vaulted PayPal]und [!DNL Pay Later] Änderungen**: Angemeldete Kunden, die ihre PayPal zuvor im Tresor gespeichert/gespeichert haben Konto, haben die Möglichkeit, mit Folgendem zu bezahlen:
   * [!DNL Pay Now] (Der User muss sich nicht in sein [!DNL PayPal] Konto einloggen, sondern kann mit seinem Standard-Karte bezahlen)
   * Bezahlen Sie mit einer anderen Finanzierungsquelle
   * Bezahlen Sie mit einem anderen Konto
   * [!DNL PayPal Pay Later] oder [!DNL PayPal Credit] Button

* **3DS-Unterstützung für[!DNL Google Pay]**—Die Unterstützung der 3DS-Verifizierung für nicht [!DNL Google Pay] tokenisierte Karten wurde hinzugefügt. Weitere Informationen finden Sie in der Dokumentation zu Braintree[](https://developer.paypal.com/braintree/docs/guides/3d-secure/client-side/android/v3#using-3d-secure-with-google-pay).

* **[!DNL Vault Apple Pay Payments]**—Eingeloggten Kunden erlauben, ihre Zahlungen auf ihrer Commerce-Geschäft-Konto zu speichern/zu Geschäft, um sie [!DNL Apple Pay] für zukünftige Transaktionen zu verwenden. Dies reduziert die Anzahl der Schritte auf Checkout und schafft eine schnellere Checkout Erlebnis für den wiederkehrenden Kunden.

* **[!DNL Vault Google Pay Payments]**—Eingeloggten Kunden erlauben, ihre Zahlungen auf ihrer Commerce-Geschäft-Konto zu speichern/zu Geschäft, um sie [!DNL Google Pay] für zukünftige Transaktionen zu verwenden. Dies reduziert die Anzahl der Schritte auf Checkout und schafft eine schnellere Checkout Erlebnis für den wiederkehrenden Kunden.

* **[!DNL Vault Venmo Payments]**—Angemeldeten Kunden ermöglichen, ihre [!DNL Venmo] Konten auf ihrer Commerce-Geschäft zu Geschäft Konto, um sie für zukünftige Transaktionen zu verwenden. Dies reduziert die Anzahl der Schritte auf Checkout und schafft eine schnellere Checkout Erlebnis für den wiederkehrenden Kunden.

* **[!DNL Vault ACH Payments]**—Ermöglichen Sie angemeldeten Kunden, ihre ACH-Zahlungen auf ihre Commerce-Geschäft-Konto zu übertragen/zu Geschäft, um sie für zukünftige Transaktionen zu verwenden. Dies reduziert die Anzahl der Schritte auf Checkout und schafft eine schnellere Checkout Erlebnis für den wiederkehrenden Kunden.

* **[!UICONTROL Express Payment]Schaltflächen am oberen Rand Checkout**: Um eine schnellere Checkout Erlebnis zu ermöglichen, haben wir zu Beginn der Checkout Optionen eingeführt [!DNL Express Payment] . Kunden können nun per [!DNL PayPal], [!DNL PayPal Pay Later], [!DNL Apple Pay]und [!DNL Google Pay Express] Zahlungen bezahlen.

* **[!DNL Braintree]Versionshinweise- und Support-Links in der Admin-Konfiguration** – Händler können jetzt direkt aus dem Commerce-Admin verknüpfen, um den Support zu Braintree und online zu Versionshinweise.
...
Commerce 2.4.7 enthält erweiterte GraphQL-Caching Funktionen, Unterstützung für die GraphQL-Schema für benutzerdefinierte Attribute, Unterstützung für Headless-bestellen-Abbruch und verbesserte Resolver-Caching.

* **Mehr flexibles Warenkorb** Management. Die `clearCart` Mutation löscht nun den Inhalt einer bestimmten Warenkorb mit einem einzigen Handgriff. Sie ersetzt die `clearCustomerCart` Mutation, die veraltet ist. <!-- LYNX-254 -->

* **Verbesserungen bei der Erstellung von Warenkorb Mutationen**. Die `createGuestCart` Mutation wurde hinzugefügt, um die veraltete `createEmptyCart` Mutation zu ersetzen. Wenn Sie `createEmptyCart`bisher verwendeten, konnten Sie nicht feststellen, ob die Warenkorb für einen Gast oder einen angemeldeten Kunden bestimmt war. <!-- LYNX-224 -->
...
* **Unterstützung für Auftragsstornierung**. Die [cancelOrder](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/cancel-order/)-Mutation ermöglicht es einem Kunden, eine Bestellung zu stornieren, indem er ihre Kennung und einen Stornierungsgrund übergibt. <!-- LYNX-197 -->
   ...
   * Die Felder &quot;Neu&quot; `order_cancellation_enabled` und `order_cancellation_reasons.description` &quot;Antwort&quot; im `storeConfig`
Abfrage unterstützen User initiierte bestellen Stornierungsanfragen. Weitere Informationen finden Sie unter [Abfragen der bestellen Abbruchkonfiguration eines Geschäft](https://developer-stage.adobe.com/commerce/webapi/graphql/schema/store/queries/store-config/#query-a-stores-order-cancellation-configuration)

* **Verbesserte Unterstützung für benutzerdefinierte Attribute**. Die Unterstützung benutzerdefinierter GraphQL-Attribute wurde verbessert, indem API-Daten zur Unterstützung aller Attributtypen erweitert wurden. Die GraphQL-EAV-Attribute Schema unterstützt nun das Erweitern von Kundenattributen und Kundenadressobjekten im Admin und deren Abrufen mit GraphQL. Spezifische Bereiche, in denen Verbesserungen vorgenommen werden müssen, sind: <!-- LYNX-61 110-->
...
* Die Kredit- Karte Tresorfunktion wurde für alle Zahlungsmethoden mit Ausnahme von Venmo verbessert. Käufer können jetzt ihre ACH-Zahlungen verwalten oder speichern und sie Ansicht oder aus ihrem Konto Seite löschen. Händler können ACH-Tresorzahlungen über den Administrator aktivieren und deaktivieren. <!-- BUNDLE-3324 -->

* Die Checkout arbeitsablauf enthält jetzt einen Express-Zahlungsbereich, der PayPal-, Google Pay- und Apple Pay-Schaltflächen **[!UICONTROL Express]** bietet. <!-- BUNDLE-3322 -->

[Payment Optionen](https://experienceleague.adobe.com/docs/commerce/payment-services/payments-checkout/payments-options.html) führt unterstützte Zahlungsmethoden ein.
...
Neu REST-Endpunkte unterstützen das Anzeigen, Hinzufügen und Löschen mehrerer Coupons, die einer Warenkorb zugeordnet sind.
...
Ersetzen Coupon Codes in einer Warenkorb:

`PUT /rest/{store_code}/V2/carts/{cartId}/coupons`
`PUT /rest/{store_code}/V2/carts/mine/coupons`

Entfernen Coupon Codes aus einer Warenkorb:

`POST /rest/{store_code}/V2/carts/{cartId}/coupons/deleteByCodes`
`POST /rest/{store_code}/V2/carts/mine/coupons/deleteByCodes`

**Weitere Endpunkte**
In dieser Version werden zwei neue REST-Endpunkte eingeführt, die eine Problemumgehung für eine Einschränkung mit der REST-API `GET` und `POST V1/products/attributes` den Endpunkten bieten. Diese Endpunkte geben denselben Wert für das `is_filterable` Attribut für die Optionen und `Filterable(with results)` `Filterable(no results)` Optionen der **[!UICONTROL Use in Layered Navigation]** Option zurück. (Die `is_filterable`-Attributeigenschaft ist vom Typ `Boolean`, was das Festlegen dieser Eigenschaft auf `Filterable(no results)` nicht zulässt.)
...
* Unnötige Cache-Manipulationen wurden aus dem Einrichtungsprozess entfernt. Zuvor schrieb Commerce seine Konfiguration unnötig auf die Festplatte, wenn `bin/magento setup:db-data:upgrade` OR `bin/magento setup:upgrade` ausgeführt wurde, was zu Problemen mit SOM-Modulen während des Setups führte. [GitHub-38124](https://github.com/magento/magento2/issues/38124)
...
* Die Datenbankwiederherstellung schlägt aufgrund eines Trennzeichen-Fehlers nicht mehr fehl. Zuvor gab Commerce diesen Fehler aus, wenn `bin/magento setup:rollback --db` Folgendes ausgeführt wurde: `Syntax error or access violation: 1064 You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'delimiter' at line 1, query was: delimiter ;;`.

<!-- ACP2E-1505 -->

* Der `bin/magento setup:upgrade` Befehl schlägt nicht mehr mit dieser Art von Fehler im Zusammenhang mit dem MySQL-Speicherlimit fehl: `PHP Fatal error:  Allowed memory size of 4294967296 bytes exhausted (tried to allocate 20480 bytes)`. Die Migration von Attributen mit Mehrfachauswahl wurde optimiert, um während weniger Arbeitsspeicher zu `setup:upgrade`verbrauchen.
...
* Die Ladezeiten für Checkout Seite Checkout wurden für Kunden mit großen Adressbüchern verbessert. Commerce verarbeitet jetzt nur die in der **[!UICONTROL Customer Addresses Limit]** Einstellung angegebene Anzahl an Kundenadressen. Zuvor wurde bei Commerce das gesamte Adressbuch geladen.

<!-- ACP2E-2174 -->

* Produkt Anzahl kann jetzt wie erwartet in der Warenkorb für vorrätige Artikel geändert werden, wenn ein Artikel nicht vorrätig ist. Zuvor war es nicht möglich, Produkte Anzahl Artikel zu ändern, wenn einer nicht vorrätig war.

<!-- ACP2E-2269 -->

* Der `AdvancedSalesRule` Produktattributfilter funktioniert jetzt fehlerfrei mit dem Dezimalattribut-Backend-Typ. Daher funktionieren die Warenkorb Regeln `Coupon Type` **[!UICONTROL No Coupon]** nun wie erwartet.
...
* Cookies im Kundenbereich berücksichtigen nun die Domäneneinstellung des Cookie. Zuvor wurde der Mini-Warenkorb in Stores, die Subdomains enthielten, nicht wie erwartet aktualisiert, Linear die Sitzung freigegeben war.

<!-- AC-9340 -->

* Das Senden einer bestellen an mehrere Adressen löst bei der Verarbeitung Region ID keinen Fehler mehr aus.

<!-- AC-8853 -->

* Fest-Rabatt-Beträge, die auf der Warenkorb-Ebene angewendet werden, sind jetzt korrekt.[GitHub-37496](https://github.com/magento/magento2/issues/37496)

<!-- AC-2044 -->

* Gutscheine werden jetzt erfolgreich auf eine bestellen angewendet, wenn ein Erstkäufer die Coupon anwendet, nachdem er die Pauschalversandart ausgewählt hat, bei der ein Warenkorb Preis mit der als Bedingung festgelegten Versandart Regel. Zuvor wurde auf der Warenkorbseite der Fehler „Coupon ist nicht gültig“ angezeigt und der Coupon wurde nicht angewendet. [GitHub-34866](https://github.com/magento/magento2/issues/34866)
...
* Der `applied_rule_ids` Wert in der `quote_item` Tabelle enthält nun eine korrekte Liste der angewendeten Regel-IDs. Zuvor enthielt dieser Wert nur die zuletzt angewendete Regel-ID.

<!-- ACP2E-2025 -->

* Mini-Warenkorb und Kundendaten im lokalen Datenspeicherung werden jetzt zurückgesetzt, wenn eine Sitzung vom Server entfernt wird. Bisher wurden diese Daten noch angezeigt, wenn die Sitzungsdatei entfernt wurde.
...
* Gast-API-Anforderungen geben `POST V1/guest-carts/<cartId>/shipping-information` keinen Status mehr zurück `cancel`, wenn der Seite während der Log-in in einer mobilen Umgebung neu geladen wird. Zuvor gab Adobe Systems Commerce einen 500-Fehler aus und protokollierte diese Ausnahme: `TypeError: Argument 2 passed to Magento\CustomerCustomAttributes\Model\Plugin\ProcessCustomerShippingAddressCustomAttributes::beforeSaveAddressInformation() must be of the type string, null given`.

<!-- AC-7886 -->

* Die Berechtigung für kostenlosen Versand wird nun erwartungsgemäß berechnet, wenn die Bedingung **[!UICONTROL Subtotal (Excl. Tax)]** für Warenkorb Regeln angewendet wird. [GitHub-36760](https://github.com/magento/magento2/issues/36760)
...
* Der Katalogpreis Regel die `If an item is FOUND/NOT FOUND in the cart with ALL/ANY of these conditions true` Bedingung funktionieren nun korrekt mit Kategorie und Produktnummer Attributen. Zuvor wurde diese Bedingung in Warenkorb Preis- Coupon Logik nicht korrekt angewendet, und ungültig Gutscheine wurden auf Bestellungen angewendet. [GitHub-37660](https://github.com/magento/magento2/issues/37660)
...
* Warenkorbpreisregeln werden jetzt wie erwartet angewendet, wenn ein Warenkorb Preis Regel, der sich auf eine Versandart bezieht, für die Geschäft konfiguriert ist und diese Versandart während des Bezahlvorgangs in eine andere geändert wird. Zuvor wurde der `applied_rule_ids` Wert in der `sales_order_item` Tabelle nie geändert, und der Warenkorb Preis Regel wurde nicht auf die bestellen angewendet.

### Katalog

<!-- AC-10746 -->

* Wird `bin/magento cache:clean` `bin/magento cache:flush` der gesamte integrierte oder Varnish-Seite-Cache nicht mehr geleert, wenn nichts anderes angegeben ist. [GitHub-38301](https://github.com/magento/magento2/issues/38301)

<!-- ACP2E-2257 -->

* Händler können nun das Produktkarussell verwenden, um CMS-Blöcke zu erstellen, wenn `catalog_product_price dimensions-mode` auf eingestellt ist `website`. Zuvor hat Commerce den Block nicht gespeichert und diesen SLQ-Fehler ausgegeben: `report.CRITICAL: PDOException: SQLSTATE[42S02]: Base table or view not found: 1146 Table`.
...
* Der Bereinigungsprozess für zwischengespeicherte Bilddateien wurde verbessert, um das Erstellen von versteckt Verzeichnissen im `pub/media/catalog/product` Ordner zu vermeiden. Zuvor führten versteckt Verzeichnisse zu Speicherplatzproblemen bei Bereinigungsvorgängen. Der Vorgang konnte beendet werden, wodurch temporäre versteckt Ordner zurückblieben, die nie gelöscht wurden.

<!-- AC-10316 -->

* Die Preise für Bundle-Produkte werden jetzt korrekt berechnet, und ein Problem mit der bestellen von Vorgängen bei der Preisberechnung wurde behoben. [GitHub-35665](https://github.com/magento/magento2/issues/35665)

<!-- AC-6996 -->

* Eine unnötige Klausel wurde aus `catalog_product_price` Indexabfragen entfernt, wodurch die Leistung dieses Indexers in Stores mit großen Katalogen verbessert wurde. [GitHub-32382](https://github.com/magento/magento2/issues/32382)
...
* Kürzlich angezeigte Produktinformationen werden jetzt gemäß Geschäft Ansicht Konfiguration angezeigt. Bisher wurden die kürzlich angezeigten Produktdaten nicht pro Geschäft Ansicht aktualisiert, einschließlich des Namens und der bevorzugten Sprache.

<!-- ACP2E-2296 -->

* Vimeo-Videos werden jetzt wie erwartet auf Produktseiten in mobilen Ansicht in Chromium-basierten Webbrowsern wiedergegeben.

<!-- ACP2E-1959 -->

* Der `bin/magento catalog:images:resize` Befehl generiert nun korrekt Produktbilder für die Produkte, die einer benutzerdefinierten Website mit einem benutzerdefinierten Design zugewiesen sind.

<!-- ACP2E-1982 -->

* Metadaten mit `NULL` Oder-Werten `NOT NULL` werden jetzt für die Standard-Geschäft gemäß dem Kontrollkästchen **&quot;Standardmäßig Wert** wie erwartet verwenden&quot; gespeichert. Zuvor wurde Metadaten mit `NULL` Wert nicht gespeichert, wenn dieses Kontrollkästchen deaktiviert war.

<!-- ACP2E-2093 -->

* Händler können jetzt erfolgreich ein vorhandenes Bild aus den Produktdetails Seite löschen und dann ein neues Bild mit demselben Namen Upload. Zuvor wurde in der Schaufenster-Produktseite zuvor nicht das richtige Bild angezeigt.

<!-- ACP2E-2128 -->

* Das `productDetail` Abfrage gibt jetzt den Produktnamen statt null zurück, wenn das Produktbildattribut `alt` leer ist.

<!-- ACP2E-2215 -->

* Bestellungen, die sowohl herunterladbare als auch physische Produkte enthalten, enthalten jetzt funktionierende Links zum herunterladbaren Produkt, sobald die bestellen abgeschlossen ist. Zuvor waren Links zu herunterladbaren Produkten erst verfügbar, nachdem die physischen Produkte derselben bestellen ausgeliefert wurden.

<!-- ACP2E-2343 -->

* URL Umschreibungen werden jetzt aktualisiert, wenn ein Kategorie von einem Geschäft-/Stamm-Kategorie in einen anderen Geschäft-/Stamm-Kategorie verschoben wird. Veraltete Datenbankeinträge werden nun entfernt, wenn die Unterkategorien in neue übergeordnete Kategorien übertragen werden. Die Datenbank enthält jetzt nur noch relevante Einträge. Zuvor wurde die `url_path` nicht mit der richtigen Store-ID aktualisiert.
...
* Die Leistung bei der teilweisen Neuindizierung für die Indexer für Kategorien „Produkte“ und „Produktkategorien“ wurde verbessert. Zuvor wurden im Cron-Auftrag mehrmals pro einzelnem `indexer_update_all_views` Produkt oder Kategorie Neuindizierer ausgeführt.
...
* Die Produktposition und die ID-Auswahl werden jetzt korrekt angezeigt, wenn ein Administrator ein neues Produkt zu einer Kategorie hinzufügt User, nachdem er den Cache gelöscht, aber die Kategorie Seite nicht neu geladen hat. Zuvor waren Produktposition und -auswahl nicht aufeinander abgestimmt und wurden falsch angezeigt.
...
* Couponcodes, die Leerzeichen enthalten, werden nicht mehr ungültig. Wenn ein Coupon Code zuvor ein Leerzeichen enthielt (vor oder nach dem eigentlichen Code), schlug Tauglichkeitsprüfung fehl. [GitHub-38048](https://github.com/magento/magento2/issues/38048)

<!-- ACP2E-1551 -->

* Käufer können jetzt zwei separate, automatisch generierte Coupon Codes verwenden, die von derselben Warenkorb Preis Regel generiert wurden. Das Feld `Uses per Coupon` ist jetzt aktiviert, wenn der Coupontyp als `Auto` ausgewählt wurde (ähnlich für Coupontyp =`Specific Coupon`) . Dies wiederum ermöglicht es dem Käufer, mehrere Gutscheincodes auf denselben Warenkorbpreis anzuwenden, wenn die Codes unterschiedlich sind.
...
* Der Name der `reponseBody`-Variablen wurde in `app/code/Magento/CatalogRule/Controller/Adminhtml/Promo/Catalog/NewConditionHtml.php` in `responseBody` geändert.[GitHub-38093](https://github.com/magento/magento2/issues/38093)
...
* Der `trim-input.js` wurde eine fehlende `jQuery` hinzugefügt. [GitHub-37683](https://github.com/magento/magento2/issues/37683)
...
* Adobe Systems Commerce protokolliert jetzt wie erwartet eine Ausnahmemeldung, wenn die vom MIAS Tauglichkeitsprüfung-Dienst Tauglichkeitsprüfung Umsatzsteuer-Identifikationsnummer fehlschlägt. [GitHub-36065](https://github.com/magento/magento2/issues/36065)

<!-- AC-8146 -->

* Der `Administrators` Name wurde aus der Abfrage entfernt, die zum Abrufen der Rolle eines Administrators während der Admin-Rolle Erstellung verwendet wurde. [GitHub-36998](https://github.com/magento/magento2/issues/36998)

<!-- AC-8607 -->

* Der `bin/magento setup:config:set` Befehl schlägt nicht mehr fehl, wenn die Datei einen ungültig Datenbanknamen User `app/etc/env.php` enthält. [GitHub-37409](https://github.com/magento/magento2/issues/37409)

<!-- AC-8595 -->

* Das Sortieren nach Spalten für reservierte Wörter in einer standardmäßigen Admin UI-Komponente führt nicht mehr zu einem SQL-Fehler in `var/log/exception.log`. [GitHub-37423](https://github.com/magento/magento2/issues/37423)
...
* `Param $options[`Position`]` für Währungssymbole funktioniert jetzt wie erwartet und unterstützt die Anpassung der Position des Währungssymbols. Zuvor, nach der Migration von Zend Framework 1, ignorierte die `toCurrency` Methode den `position` Parameter. Dieses Problem trat in der gesamten Admin-Oberfläche auf.

<!-- AC-8817 -->

* Veralteter Code im Zusammenhang mit der Erstellung dynamischer Eigenschaften in der gesamten Codebasis wurde umgestaltet.
...
* Die Instanziierung des Sperranbieters erfolgt jetzt über `\Magento\Framework\Lock\Proxy` die Klasse. Der Sperranbieter ist jetzt mit der `lock` Einstellung über die `app/etc/env.php` Datei konfiguriert.

<!-- ACP2E-1492 -->

* Mutex wurde für Befehle implementiert, um Gleichzeitigkeitsbedingungen während der Aktualisierung durch gleichzeitige Anforderungen zu verhindern. Zuvor wurden gleichzeitige Anfragen (Race Conditions) für bestellen Abbrüche zur Duplizierung von Einträgen in der `inventory_reservation` Tabelle geführt.

<!-- ACP2E-1381 -->

* Die `populateWithArray` Funktion wandelt Objekteigenschaften nun korrekt in Snake Case um, sodass sie mit den `AbstractModel` Gettern und Settern kompatibel ist. Zuvor war die Formatierung der Groß-/Kleinschreibung falsch, wenn der Datenattributname mehrere Großbuchstaben hintereinander enthielt.
...
* Adobe Commerce löst keine Ausnahme mehr in der Protokolldatei aus, wenn ein(e) Benutzende(r) versucht, ein Versandlabel zu drucken. Wenn eine Erweiterung zuvor Antwortheader ändert, die eine Anlage enthalten, löste das System eine Ausnahme in der Protokolldatei aus.

<!-- AC-7986 -->

* Unterstützung für mehr HTML Klassen wurde hinzugefügt.`elements.xsd` [GitHub-36891](https://github.com/magento/magento2/issues/36891)

### Allgemeine Fehlerbehebungen

<!-- AC-10591 -->

* Der Name der `reponseBody` Variable wurde in `responseBody` geändert `app/code/Magento/CatalogRule/Controller/Adminhtml/Promo/Catalog/NewConditionHtml.php`.[GitHub-38093](https://github.com/magento/magento2/issues/38093)

<!-- ACP2E-2647 -->

* Durch die Planung von Produktaktualisierungen werden die Mehrfachauswahl-Attributdaten nicht mehr gelöscht. Wenn zuvor ein Update für ein Produkt geplant war, wurden die Attributdaten für die Mehrfachauswahl des Produkts fälschlicherweise gelöscht. [GitHub-37675](https://github.com/magento/magento2/issues/37675)

<!-- AC-2904 -->

* Das Speichern eines Produkts mit einer nicht standardmäßigen Geschäft Umfang führt nicht mehr dazu, dass unveränderte Attribute Geschäft-Gültigkeitsbereich werden, wenn sie mit geladen werden `ProductRepository`. [GitHub-8897](https://github.com/magento/magento2/issues/8897)

<!-- ACP2E-2132 -->

* Käufer können nun auf Seiten zugreifen, die als Hierarchie Knoten konfiguriert sind, wenn Zugriffsbeschränkungen aktiviert sind. Zuvor trat eine unendliche Weiterleitungsschleife auf, und der Browser gab diesen Fehler aus: `ERR_TOO_MANY_REDIRECTS`.
...
* Admin-Benutzer mit eingeschränktem Zugriff auf einen bestimmten Store können jetzt eine Massenaktualisierungsaktion verwenden, um Produktüberprüfungen zu aktualisieren. Zuvor gab Commerce diese Ausnahme aus: `report.CRITICAL: TypeError: array_intersect(): Argument #1 ($array) must be of type array, null given in app/code/Magento/AdminGws/Model/Models.php:439`.

<!-- AC-8600 -->

* Die Storefront Log-in Anzeigen Passwort Seite Funktionen zeigt jetzt die Kennwörter wie erwartet an. Bisher wurden Kennwörter nicht angezeigt. [GitHub-37432](https://github.com/magento/magento2/issues/37432)
...
* Das CMS-Seite Raster Filter Seiten nun basierend auf der Geschäft Ansicht, die der Admin-User zugewiesen ist. Zuvor wurde Rolle Umfang nicht angewendet.

<!-- AC-8823 -->

* Passwörter werden nun wie erwartet angezeigt, wenn das **[!UICONTROL Show Password]** Kontrollkästchen im Log-in Seite aktiv ist.

<!-- ACP2E-2037 -->

* Die Zurücksetzen Passwort Token Systemattribut der Kundenentität (`rp_token`) Tauglichkeitsprüfung wurde während der Erstellung der Kunden Konto aus dem Attribut Tauglichkeitsprüfung entfernt, und diakritische Zeichen Tauglichkeitsprüfung sind nur in der resultierenden Kunden-E-Mail enthalten. Zuvor hat Commerce den Kundendatensatz nicht gespeichert und den folgenden Fehler angezeigt: `Something went wrong while saving the customer`.
...
* Im Feld &quot;Bundesland/Kanton **der Admin-Kundenadresse**&quot; wird nun der zuletzt gespeicherte Wert wie erwartet beibehalten. Wenn Sie zuvor den Wert aus diesem Feld entfernt haben, zeigte Commerce den gelöschten Wert weiterhin im **Feld Bundesland/Region** an. [GitHub-36846](https://github.com/magento/magento2/issues/36846)
...
* Der CMS-Hierarchiefilter funktioniert erwartungsgemäß, nachdem Sie eine Store-Ansicht gefiltert und dann auf Admin **[!UICONTROL Content]** > **[!UICONTROL Hierarchy]** **[!UICONTROL Save]** geklickt haben. Zuvor wurde durch Klicken auf **[!UICONTROL Save]** die Seite aktualisiert, aber der Kontext ging verloren und die ausgewählte Store-Ansicht wurde nicht mehr angezeigt.
...
* Die `get()`-Methode der `OptionValueProvider`-Klasse gibt jetzt erwartungsgemäß einen Attributoptionenwert zurück, der auf dem angegebenen `option_id` basiert. Zuvor wurde ein Fehler zurückgegeben. [GitHub-35910](https://github.com/magento/magento2/issues/35910)
...
* Der Produktimport wird nicht mehr unterbrochen, wenn Produktbilder fehlen. Wenn zuvor ein Produktbild beim Import eines Drittanbieterdienstes mit einer CSV Datei fehlte, zeigte Adobe Systems Commerce diesen Fehler an: `Maximum error count has been reached or a system error is occurred!`.
...
* Attributoptionen, die vom Datenquelle Modell bereitgestellt und mit den Setupdaten installiert Patch (in der Regel von Modulen von Drittanbietern) installiert wurden, können jetzt mit Kunden-Segment Regeln verwendet werden. Zuvor gab diese Kombination nicht die Liste der Kunden zurück, die mit der konfigurierten Segment übereinstimmten.

<!-- AC-7093 -->

* Die E-Mail-Vorlage-Engine kann nun bestimmte verschachtelte Anweisungen (z. B `{{if}}{{depend}}...{{/depend}}{{/if}}`. ). [GitHub-36438](https://github.com/magento/magento2/issues/36438)

<!-- AC-7920 -->

* `product` Abfragen mit aggregierten Daten geben nun die korrekten Bezeichnungswerte für Produktattribute vom Typ Boolesch zurück. [GitHub-29123](https://github.com/magento/magento2/issues/29123)

<!-- https://github.com/magento/magento2/pull/29173 -->

* CSS-Dateien werden nicht mehr beschädigt, wenn sie zusammengeführt werden, wenn `var/tmp` sie `pub/static` sich auf verschiedenen Dateisystemen befinden und **[!UICONTROL CSS Merging Enabled]** aktiviert ist. Temporäre Dateien wurden im selben statischen Verzeichnis wie die Zieldatei erstellt, um sicherzustellen, dass sich beide Dateien im selben Dateisystem befinden. Daher ist der Aufruf zum Umbenennen atomar. [GitHub-29172](https://github.com/magento/magento2/issues/29172)

<!-- https://github.com/magento/magento2/pull/36769 -->

* Fest ein potenzieller Fehler beim Aufrufen einer Memberfunktion `getId()` am `int`, die gelegentlich eine Ausnahme auslöste, wenn ein Kunde im Admin angezeigt wurde.
...
* Produkte werden jetzt nach einer Gutschrift, die eine Rückgabe von Produkten Anzahl beinhaltet, automatisch in den Status &quot;Auf Lager&quot; zurückgesetzt. Wenn ein Produkt nicht vorrätig war, aber eine Gutschrift den Bestand dieses Produkts zurückgab, mussten Händler den Produktbestandsstatus manuell ändern.
...
* REST `V1/products/<sku>` löst nun beim Aktualisieren des Lagerstatus eines Produkts eine automatische Neuindizierung des Lagerbestands aus. Zuvor wurde für das Produkt, das aktualisiert wurde, keine Neuindizierung des Lagerbestands ausgelöst.

<!-- ACP2E-1653 -->

* Der konfigurierbare Produktbestandsstatus wird jetzt wie erwartet in der Storefront aktualisiert, wenn untergeordnete Produkte von `V1/inventory/source-items`aktualisiert werden.

<!-- ACP2E-2114 -->

* Der `POST <store_code>/V1/inventory/source-items` REST-Aufruf überprüft nun Payload auf Leerzeichen in zurückgegebenen Warenbestand Quellelementen und sendet bei Bedarf eine Fehlermeldung über Tauglichkeitsprüfung.

<!-- ACP2E-2072 -->

* Händler können Käufer jetzt benachrichtigen, dass ein bestellen zur Abholung bereit ist, wenn die **[!UICONTROL No Manage Stock]** Einstellung für ein Produkt aktiviert ist. Wenn diese Einstellung aktiviert war, zeigte Commerce zuvor diese Fehlermeldung an: `Your order is not ready for pickup`

<!-- ACP2E-2227 -->

* Händler können jetzt eine Gutschrift für Bestellungen erstellen, aus denen ein einfaches Produkt, das einem konfigurierbaren Produkt zugeordnet ist, gelöscht wurde. Zuvor konnten Händler die Gutschrift nicht erstellen, und Commerce hat eine `TypeError` Ausnahme ausgelöst.
...
* `AUTO_INCREMENT``inventory_source_item` der Tabelle wird nicht mehr mit jeder `UPDATE` Operation erhöht. Zuvor wurde bei jeder Aktualisierung der `AUTO_INCREMENT` Wert dieser Tabelle erhöht, was schließlich dazu führte, dass der Wert außerhalb des `AUTO_INCREMENT` zulässigen Bereichs lag, wenn ein neuer Datensatz zur `inventory_source_item table`. Admin-Benutzer erhielten daher die folgende Fehlermeldung, als sie versuchten, ein neues Produkt über die Admin-`Numeric value out of range...` zu erstellen: .
...
* Das Datum-Uhrzeit-Format in der Funktion &quot;Systemberichte&quot; wurde aktualisiert, sodass Datensätze aus Protokolldateien in Berichte aufgenommen werden.

<!-- ACP2E-1385 -->

* Admin-Benutzer können jetzt die Protokolle für Massenaktionen, die durch Integrationen erstellt wurden, im Abschnitt &quot;Massen-Aktionen-Protokoll&quot; des Administrators anzeigen.

### Einloggen

<!-- ACP2E-1521 -->

* Das Zurücksetzen einer Kennwort in einer Browser und das anschließende Protokollierung über eine andere Browser führt nicht mehr zu einer Ausnahme. [GitHub-36447](https://github.com/magento/magento2/issues/36447)
...
* Der `GET V1/orders/<OrderID>` Endpunkt gibt nun Informationen sowohl zu den konfigurierbaren als auch zu den einfachen Produkten in der bestellen zurück, unabhängig vom Lagerstatus der einfachen Produkte. Admin-Benutzer können jetzt nur dann Bestellungen aufgeben, wenn die ausgewählten Artikel (Produkte) auf Lager oder verkaufsfähig sind. Zuvor gab diese API nur Informationen zu den Produkten zurück, die auf Lager waren.

<!-- AC-7901 -->

* Die Gutschrift Seite stürzt nicht mehr ab, wenn gratis Versand aktiviert ist, wenn der Versandpreis Steuern enthält, und Steuerberechnungen werden nach Rabatten angewendet. Zuvor gab Adobe Systems Commerce eine `Division by zero` Ausnahme an. [GitHub-36800](https://github.com/magento/magento2/issues/36800)

<!-- AC-1342 -->

* Die Verwendung des `rest/V1/orders/{id}/comments`-Endpunkts zum Posten eines Kommentars zu einer Bestellung ohne Angabe des Bestellstatus wirkt sich nicht mehr auf die Anzeige der Bestellung aus. Zuvor wurde bestellen Status in den `sales_order` Tabellen und `sales_order_grid` als NULL protokolliert, und weder das Seite &quot;Meine Bestellungen&quot; noch das bestellen-Raster &quot;Admin&quot; zeigten die bestellen an. [GitHub-34180](https://github.com/magento/magento2/issues/34180)
...
* Bilder behalten nun das korrekte Seitenverhältnis bei, wenn die Größe in Page Builder geändert wird. [GitHub-37493](https://github.com/magento/magento2/issues/37493)
...
* Prämienpunkte Gültigkeit E-Mails werden nach Ablauf der Punkte nicht mehr versendet. Die und die `magento_reward_balance_warning_notification` Cron-Aufgaben wurden umgestaltet, um die Flexibilität und `magento_reward_expire_points` die Kapazität zum Senden von E-Mails zu erhöhen. Bisher konnten Händler nicht viele E-Mails, die von diesen Cron-Aufgaben generiert werden, in kurzer Zeit versenden. Dies hätte zu Verzögerungen bei der Zustellung zeitkritischer Benachrichtigungen führen können.

<!-- ACP2E-2283 -->

* Abgelaufene Prämienpunkte werden jetzt wie erwartet vom aktuellen Prämienpunktestand eines Erstkäufer abgezogen.

<!-- ACP2E-1473 -->

* Die E-Mail zum Aktualisieren des Prämienpunktestandes Benachrichtigung wird jetzt Konto den aktuellen Geschäft Kontext berücksichtigt. Zuvor verwendete die E-Mail zum Aktualisieren des Prämienpunktestandes Konfigurationseinstellungen für die Standard Geschäft.

<!-- ACP2E-1329 -->

* Prämienpunkte können jetzt nach der Erstellung einer Gutschrift erstattet werden. Zuvor konnten Händler nach der Erstellung einer Gutschrift keine Prämienpunkte erstatten, und bestellen Status blieb `Completed`erhalten, nicht `Closed`.

### RMA

<!-- ACP2E-2246 -->

* Das REST-Anfrage `POST /V1/returns` erstellt nun eine RMA pro Produkt. Bisher konnte dieses Anfrage Tauglichkeitsprüfung umgehen und mehrere RMAs pro Produkt zurückgeben.

<!-- ACP2E-2450 -->

* RMA-Attribute werden jetzt automatisch zum standardmäßigen EAV-Formular hinzugefügt, wenn das **[!UICONTROL Show on Storefront]** RMA-Attribut auf **&quot;Nein**&quot; gesetzt ist. Zuvor war das Popup mit den RMA-Artikeldetails leer, wenn ein benutzerdefiniertes Rückgabeattribut erstellt wurde, und das **[!UICONTROL Show on Storefront]** RMA-Attribut wurde auf **Nein** gesetzt.
...
* Die Vorschläge zur automatischen Vervollständigung suchen im Mini-suchen-Frontend des Headers funktionieren jetzt wie erwartet. Bisher wurde dieses Feld nicht bei der automatischen Vervollständigung ausgefüllt, wenn diese Funktion aktiviert war. [GitHub-37557](https://github.com/magento/magento2/issues/37557)
...
* Mögliche Werte werden nun im informativen Text unter dem `Storefront Properties` Eingabefeld des `Search Weight`-Attributs unter Admin **[!UICONTROL Stores]** > **[!UICONTROL Attributes]** > **[!UICONTROL Product]** beschrieben. [GitHub-36646](https://github.com/magento/magento2/issues/36675)
...
* Die `cart` Abfrage gibt nun einen `selected_shipping_method` Wert zurück, der mit einem der `available_shipping_methods` Träger- und Methodencodes übereinstimmt. Wenn eine der ausgewählten Versandmethoden zuvor einen Unterstrich enthielt, stimmten diese Träger-/Methodencodes nicht überein. [GitHub-36606](https://github.com/magento/magento2/issues/36606)

<!-- AC-2556 -->

* Die `setShippingAddressesOnCart` Mutation löst keinen Fehler mehr aus, wenn der zweite Wert im street-Array null ist. Zuvor wurde diese Ausnahme wie folgt ausgegeben: `The address failed to save. Verify the address and try again`. [GitHub-35160](https://github.com/magento/magento2/issues/35160)

### Sitemap

<!-- AC-2465 -->

* Das XML-Sitemap funktioniert jetzt wie erwartet in einem mehrstöckigen Implementierung. Zuvor enthielten die Sitemaps nicht die zugewiesenen Standardseiten für jede Geschäft. [GitHub-35001](https://github.com/magento/magento2/issues/35001)

<!-- AC-2267 -->

* Händler können jetzt ein Produkt erstellen und speichern, wenn der Website `id != 1` - und Single-Geschäft-Modus aktiviert ist. Zuvor schlug die Aktion &quot;Speichern&quot; mit dieser Meldung fehl: `SQLSTATE[23000]: Integrity constraint violation: 1452 Cannot add or update a child row: a foreign key constraint fails` [GitHub-35009](https://github.com/magento/magento2/issues/35009)

### Inszenierung

<!-- ACP2E-2665 -->

* Staging-Aktualisierungen für Vertriebsregeln werden im Staging-Dashboard nicht mehr dupliziert.

<!-- ACP2E-2173 -->

* Bundle-Produkte werden jetzt ordnungsgemäß aktualisiert, wenn ein Erstkäufer sie zu ihrer Warenkorb hinzufügt, während eine Zeitplanaktualisierung ausgeführt wird. Wenn zuvor ein Paket Produkt mit Optionen zur Warenkorb hinzugefügt wurde, während ein Zeitplan-Aufgabe in Bearbeitung war, löste Commerce diese Ausnahme aus: `Some of the products below do not have all the required options. Please select all required options`.

<!-- ACP2E-2252 -->

* verzögern Updates behalten nun die korrekten Preise für Paket Optionen bei. Zuvor wurden diese Preise für bestimmte Websites oder Geschäft Aufrufe auf null geändert.

<!-- ACP2E-2150 -->

* Beim Aktualisieren eines geplanten Updates wird die vorherige Version des bereitgestellten Elements nicht mehr entfernt, wenn kein Enddatum angegeben ist. Wenn zuvor ein bereitgestelltes Element aktualisiert wurde, wurde die Rollback-Version des Elements entfernt, wenn kein Enddatum angegeben wurde. Commerce hat vor dem Löschen keinen Fehler ausgelöst oder Admin-Benutzer gewarnt.
...
* Das Aufhängen eines Staging-Updates führt nicht mehr zum Entfernen geplanter Aktualisierungen, denen ein späterer Zeitpunkt zugewiesen ist.

<!-- ACP2E-1501 -->

* JavaScript Fehler treten nicht mehr auf, wenn Sie geplante Aktualisierungen für Kategorien hinzufügen oder bearbeiten, wenn Google Analytics Inhaltstests aktiviert sind.

<!-- ACP2E-1344 -->

* Händler können eine bestehende Zeitplanaktualisierung nun erfolgreich für eine Kategorie speichern, nachdem sie angezeigt oder bearbeitet wurde. Zuvor hatte Adobe Systems Commerce einen Fehler in `system.log`.

<!-- ACP2E-1596 -->

* Herunterladbare Links werden jetzt wie erwartet beibehalten, wenn ein geplantes Update angewendet wird, während sich zuvor hinzugefügte Produkte in der Warenkorb befinden. Zuvor verschwanden herunterladbare Links aus dem Mein Konto des Kunden (Meine herunterladbaren Produkte) Seite und der Admin-bestellen Ansicht Seite.

<!-- ACP2E-1458 -->

* Produkte sind jetzt nach einer Staging-Aktualisierung, die die Anwendung des Produkts ermöglicht, wie erwartet in der Storefront sichtbar. Zuvor war das Produkt in der Admin-Kategorie aktiviert, aber nicht in der Storefront sichtbar, wenn der Indexer-Modus der Katalog-Warenbestand auf Aktualisierung auf verzögern festgelegt war. Das Problem wurde durch eine vollständige Neuindizierung behoben.

<!-- ACP2E-1647 -->

* Der `staging.synchronize_entity_period` Consumer Warteschlange in der `magento_bulk` Tabelle nimmt nicht mehr zu, wenn keine Staging-Updates verarbeitet werden. Zuvor `cron` wurde bei der Konfiguration der Ausführung jede Minute ein neuer Datensatz für den `staging.synchronize_entity_period` Verbraucher zu dieser Tabelle hinzugefügt.

<!-- ACP2E-1415 -->

* Adobe Systems Commerce löst keinen SQL-Fehler mehr aus, wenn Sie eine Zeitplanänderung für ein Produkt erstellen, während Sie ein anderes Produkt speichern. Zuvor hat Adobe Commerce diesen Fehler angezeigt: `The product with the SKU "%1" couldn't be added to the current update`.
...
* Commerce zeigt in Admin **[!UICONTROL System]** > **[!UICONTROL Extensions]** > **[!UICONTROL Integrations]** keine `Integration not secure` mehr an, wenn die **[!UICONTROL Callback URL]**- und **[!UICONTROL Identity link URL]** leer sind. [GitHub-36407](https://github.com/magento/magento2/issues/36407)
...
Sie können Adobe Commerce 2.4.7 mit [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html) installieren.
