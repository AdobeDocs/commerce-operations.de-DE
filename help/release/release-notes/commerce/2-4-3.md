...
* **Wunschlisten**. Die [addWishlistItemsToCart-Mutation](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/add-items-to-cart/) verschiebt Elemente aus der angegebenen Wunschliste in den Warenkorb des Kunden. <!-- magento/partners-magento2ee#449-->

* **Geschenkregister**. Behandelte Aufgaben: <!-- PWA-1290-->

   * Verwenden Sie die [SchenkungRegistry-Abfrage](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/gift-registry/), um den Inhalt der Geschenkregister des Kunden zurückzugeben.

   * Suchen Sie nach Geschenkgutscheinen anhand von [Typ](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/type-search/), [E-Mail](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/email-search/) oder [Kennung](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/id-search/).

   * [Erstellen Sie ](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/create/), [aktualisieren](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/update/) oder [löschen](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/remove/) Geschenkgutscheine.

   * [Aktualisieren Sie](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/update-items/) oder [entfernen Sie ](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/remove-items/) Elemente aus einer Geschenkregistrierung.
   ...
   * [Fügen Sie ](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/add-registrants/), [update](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/update-registrants/) oder [remove](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/remove-registrants/) -Registrierungspflichtige aus einer Geschenkregistrierung hinzu.

   * [Geben Sie ](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/share/) eine Geschenkregistrierung für eingeladene Personen frei.

* **Negotiable Anführungszeichen**. Siehe die Abfragen [`negotiableQuote`](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/negotiable-quote/queries/quote/) und [`negotiableQuotes`](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/negotiable-quote/queries/quotes/) . <!-- PWA-1292-->
...
* Die [`dynamicBlocks` -Abfrage](https://developer.adobe.com/commerce/webapi/graphql/schema/store/queries/dynamic-blocks/) gibt den Inhalt der dynamischen Blöcke zurück, die mit den angegebenen Filtern übereinstimmen.
...
* Die Anwendung gibt keinen Fehler mehr aus, wenn ein Plug-in zu einer übergeordneten Klasse hinzugefügt wird. (Der Parameter `optionsProvider` wird jetzt nach `getContentIdentities` in `Assest.php` deklariert.) Zuvor gab die Anwendung den folgenden Fehler aus: `Error: Cannot instantiate interface Magento\Framework\Data\OptionSourceInterface`. [GitHub-31291](https://github.com/magento/magento2/issues/31291)
