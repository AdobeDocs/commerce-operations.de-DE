...
[Live Search](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview) unterstützt durch [Adobe AI](https://business.adobe.com/ai.html) bietet ein intuitives Sucherlebnis, indem Algorithmen für künstliche Intelligenz und maschinelles Lernen verwendet werden, um eine tiefgehende Analyse aggregierter Besucherdaten durchzuführen. Siehe [Versionshinweise zur Live Search](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html).
