...
[Live Search](https://experienceleague.adobe.com/de/docs/commerce/live-search/overview) unterstützt von [Adobe AI](https://business.adobe.com/de/ai.html) bietet ein intuitives Sucherlebnis, indem Algorithmen für künstliche Intelligenz und maschinelles Lernen verwendet werden, um eine umfassende Analyse aggregierter Besucherdaten durchzuführen. Siehe [Versionshinweise zur Live Search](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html?lang=de).
