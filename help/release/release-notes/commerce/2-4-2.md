...
description: Erfahren Sie mehr über neue Funktionen, Verbesserungen, Fehlerbehebungen und bekannte Probleme in Version 2.4.2 von Adobe Commerce.
...
* Unterstützung für mehrere Wunschlisten wurde hinzugefügt. Sie können GraphQL verwenden[&#x200B; um Wunschlisten zu erstellen](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/create/), [löschen](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/delete/) und [umbenennen](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update/) sowie [&#x200B; Elemente &#x200B;](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/move-products/) oder [kopieren](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/copy-products/). <!-- MC-32356-->

* Unterstützung für zurückgegebene Warenautorisierungen (RMA) wurde hinzugefügt. Käufer können [eine Rücksendung anfordern](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/request-return/). Wenn der Händler die Anfrage akzeptiert, kann der Käufer Aufgaben wie [Hinzufügen eines Kommentars](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-comment/) und [Hinzufügen von Tracking-Informationen](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-tracking/) ausführen<!-- MC-34596-->

* Unterstützung für die folgenden B2B-Funktionen wurde hinzugefügt:
   * Firmen. Sie können Firmen [Administratoren](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create/), [Benutzer](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-user/), [Rollen](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-role/) und [Teams](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-team/) hinzufügen<!-- MC-33861-->
   * Firmenkredit. Die [Firmenabfrage](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/queries/company/) enthält Details zur Kredithistorie des Unternehmens. <!-- MC-33862-->
   * Anforderungslisten Anforderungslisten [erstellen](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/create/), [löschen](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete/) und [aktualisieren](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/update/). Der Support umfasst auch die Möglichkeit, [Hinzufügen](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-products/), [Aktualisieren](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update-products/), [Löschen](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete-items/), [Kopieren](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/copy-items/) und [Verschieben](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/move-items/) Artikel innerhalb einer Anforderungsliste sowie Anforderungslistenelemente [in den Warenkorb &#x200B;](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-items-to-cart/). <!-- MC-34312-->
...
**Bestellungen können jetzt über Online-Zahlungsmethoden abgeschlossen werden**. B2B-Käufer werden bei der ersten Kasse aufgefordert, für jede [Bestellung](https://experienceleague.adobe.com/de/docs/commerce-admin/b2b/purchase-orders/purchase-order-flow) ihre bevorzugte Zahlungsmethode auszuwählen. Nachdem die Bestellung genehmigt wurde, werden die Käufer aufgefordert, Zahlungsdetails einzugeben, um die Bestellung in eine endgültige Bestellung umzuwandeln.
...
* Page Builder erfordert nicht mehr, dass alle Inhaltstypen in einer Zeile platziert werden. Die [Page Builder-Phase](https://experienceleague.adobe.com/de/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#stage) ist jetzt anfänglich leer und unterstützt das direkte Hinzufügen der folgenden Inhaltstypen zur Phase: Zeilen, Spalten, Registerkarten, HTML-Code, Blöcke, dynamische Blöcke.

* Vordefinierte Ränder und Abstände sind für Inhaltstypen nicht mehr erforderlich.

* Mit dem neuen [&#x200B; für Mobilgeräte &#x200B;](https://experienceleague.adobe.com/de/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#viewports)Viewport-Umschalter) und dem Viewport-Bereich für Formularfeldwerte können Benutzer und Entwickler diese Aktionen durchführen:
...
Interaktive produktinterne Anleitungen bieten Händlern Tipps zur Nutzung und Informationen aus dem Admin-Bereich zu Ankündigungen neuer Funktionen, Anleitungen zu schrittweisen Anleitungen, Onboarding-Informationen und QuickInfos.  **Administratoren müssen sich vom Administrator anmelden, um eine produktinterne Anleitung zu erhalten, wenn diese Funktion nicht aktiviert ist**. Siehe [Nutzungsdatenerfassung](https://experienceleague.adobe.com/de/docs/commerce-admin/start/admin/admin) und [Admin-](https://experienceleague.adobe.com/de/docs/commerce-admin/config/advanced/admin#admin-usage).
...
* [Amazon Pay](https://commercemarketplace.adobe.com//amzn-amazon-pay-magento-2-module.html). Amazon Pay ist in dieser Version veraltet und wird in Magento 2.5.0 entfernt. Version 2.4.3 und höher enthält nur Aktualisierungen aus Kompatibilitätsgründen und Fehlerbehebungen für größere Fehler.
...
* Administratoren, deren Berechtigungen `Magento_Catalog::edit_product_design` ausschließen (Produktdesign bearbeiten), können jetzt ein neues Produkt erstellen, indem sie ein vorhandenes Produkt mit einem neuen Namen in der ausgewählten Store-Ansicht speichern. Zuvor hat die Anwendung diesen Fehler angezeigt: `Not allowed to edit the product's design attributes`. [GitHub-28106](https://github.com/magento/magento2/issues/28106)
...
* Die Anwendung gibt keinen Fehler mehr aus, wenn Sie versuchen, nach der Installation von Adobe Commerce mithilfe des `backend-frontname`-Containers `ssh` zu wechseln. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* Die Anwendung listet ein herunterladbares Produkt nicht mehr auf der Registerkarte Meine Download-Produkte auf, nachdem das herunterladbare Produkt teilweise zurückerstattet wurde. [GitHub-28388](https://github.com/magento/magento2/issues/28388)
...
* `MessageValidator` schlägt nicht mehr bei Hash-Arrays fehl, die kein `0` Element enthalten. [GitHub-30563](https://github.com/magento/magento2/issues/30563)
...
* Die Mutationen, die Produkte zu einem Warenkorb hinzufügen, berücksichtigen jetzt Katalogberechtigungen. [GitHub-30179](https://github.com/magento/magento2/issues/30179)
...
* Adobe Commerce hat die Cache-Leistung verbessert, da Tags nicht mehr mehrmals pro Indexerinstanz geleert werden müssen. [GitHub-29890](https://github.com/magento/magento2/issues/29890)
...
* Ein Problem mit `StorefrontProductListWidgetWithSharedCatalogTest`, das zum Überspringen des Tests führte, wurde behoben. [GitHub-322](https://github.com/magento/partners-magento2b2b/issues/322)
...
* Den MFTF-Tests für die Module `Company`, `CompanyCredit`, `CompanyPayment`, `CompanyShipping` und `ConfigurableSharedCatalog` wurden aussagekräftige Titel und Beschreibungen hinzugefügt. [GitHub-30164](https://github.com/magento/magento2/issues/30164)
...
* Gäste-Shopper können jetzt PayPal-Bestellungen aufgeben, wenn **Automatische Zuordnung zur Kundengruppe** aktiviert ist. Die Zahlung wird über das PayPal-Gateway verarbeitet, die Bestellung wird in Magento erstellt und der Käufer sieht die Dankeseite für die Bestellung. Zuvor wurde die Bestellung erfolgreich auf dem PayPal-Gateway verarbeitet, aber die Bestellung wurde nicht in Adobe Commerce erstellt. Der Erstkäufer wurde stattdessen zur Seite für die Bestellüberprüfung weitergeleitet, auf der die Anwendung den folgenden Fehler anzeigte: `Failed address validation: %1" error`. [GitHub-25399](https://github.com/magento/magento2/issues/25399)
...
* Die Anzahl der in **Stores** > **Attribut** > **Bewertung** angezeigten Bewertungen entspricht nun der Anzahl der Bewertungen in einer Bereitstellung mit mehreren Sites. [GitHub-30258](https://github.com/magento/magento2/issues/30258)
...
* Header-Werte, die URLs enthalten, werden jetzt in `ApiFunctional TestFramewor`k ordnungsgemäß geparst. [GitHub-26425](https://github.com/magento/magento2/issues/26425)
...
**Problem**: Händler müssen die TLS-Funktion Fastly Force vom Administrator aktivieren, um die globale HTTP-zu-HTTPS-Umleitung für alle Store-Seiten zu aktivieren. Siehe den [Umleiten von HTTP zu HTTPS für alle Seiten in Cloud (TLS erzwingen](https://support.magento.com/hc/en-us/articles/360006296953) Wissensdatenbank-Artikel. <!-- MC-39988-->
...
**Problem**: Das Programm erstellt wie erwartet eine Bestellung in Braintree, wenn ein Käufer **Mit Venmo bezahlen** klickt, aber die Bestellung nicht in der Admin erstellt. **Problemumgehung**: Keine. Siehe das bekannte Problem [2.4.2: Braintree Venmo-Zahlung funktioniert nicht](https://support.magento.com/hc/en-us/articles/360054662652/) Knowledgebase-Artikel.  <!-- BUNDLE-2894-->
...
**Problem**: Käufer werden zum Warenkorb weitergeleitet, wenn sie versuchen, eine Bestellung über eine Bestellung mit PayPal Express Checkout aufzugeben, wenn **Kontextmodus** deaktiviert ist. <!-- B2B-1604-->

**Problem**: Die Anwendung zeigt manchmal einen 404-Fehler an, wenn ein Käufer eine Bestellung erstellt und dann zur Kaufbestätigungsseite navigiert. Dieser Fehler tritt auf, wenn ein Käufer zuvor eine andere Bestellung mit einer Online-Zahlungsmethode erstellt hat, bevor er zur Kasse navigiert, ohne den vorherigen Kauf abzuschließen. Der Käufer kann die Bestellung dennoch aufgeben. **Problemumgehung**: Keine. <!-- B2B-1605-->

**Problem**: Rabatte für eine bestimmte Zahlungsmethode bleiben während des Checkouts für eine Bestellung bestehen, auch wenn der Käufer seine Zahlungsmethode während des endgültigen Checkouts ändert. Daher erhalten Kunden möglicherweise einen Rabatt, zu dem sie keinen Anspruch haben. Dies liegt daran, dass für die ursprüngliche Zahlungsmethode trotz der Änderung der Zahlungsmethode weiterhin eine Warenkorbregel angewendet wird. **Problemumgehung**: Keine. Siehe das bekannte Problem [2.4.2 B2B: Rabatt bleibt für Online-Bestellungen bestehen, nachdem die Zahlungsmethode geändert wurde](https://support.magento.com/hc/en-us/articles/360054667312) Knowledgebase-Artikel. <!-- B2B-1012 -->

**Problem**: Die `deleteRequisitionListOutput` Abfrage gibt Details zur gelöschten Anforderungsliste anstelle der übrigen Anforderungslisten zurück. <!-- MC-39894-->
...
Sie können Adobe Commerce 2.4.2 mit [Composer](../../../installation/composer.md) installieren.
