...
Die Möglichkeit, eine Installation für die Verwendung einer geteilten Datenbank zu konfigurieren, wird in dieser Version nicht mehr unterstützt. Händler, die derzeit die Split-Datenbank verwenden, sollten mit der Planung beginnen, zu einer einzelnen Datenbank zurückzukehren oder zu ihr zu migrieren, oder einen alternativen Ansatz verwenden. Migrationsanweisungen [&#x200B; Sie unter „Von einer geteilten Datenbank auf eine einzelne &#x200B;](../../../configuration/storage/revert-split-database.md) zurücksetzen“.
