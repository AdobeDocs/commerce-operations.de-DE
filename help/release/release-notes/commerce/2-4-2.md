...
* Die Möglichkeit, eine Installation für die Verwendung einer geteilten Datenbank zu konfigurieren, wird in dieser Version nicht mehr unterstützt.
...
* Die Anwendung gibt keinen Fehler mehr aus, wenn Sie versuchen, nach der Installation von Adobe Commerce mithilfe des `ssh`-Containers `backend-frontname` zu wechseln. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* `DataObject` wurde durch das Produktmodell in `\Magento\MediaGalleryCatalogUi\Ui\Component\Listing\Columns\Thumbnail::prepareDataSource`.[GitHub-1711 ersetzt](https://github.com/magento/adobe-stock-integration/issues/1711)
...
* Die Anwendung zeigt nicht mehr die **Sie nicht?** Text, wenn ein Kunde beim Anmelden bei einer Bereitstellung, bei **der persistente Warenkorb aktiviert ist, die Option &quot;** speichern“ auswählt.
