...
* Unterstützung für mehrere Wunschlisten hinzugefügt. Sie können GraphQL für [create](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html), [delete](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html) und [rename](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html) Wunschlisten sowie für [move](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html) oder [copy](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html) Elemente zwischen ihnen verwenden. <!-- MC-32356-->

* Unterstützung für zurückgegebene Warenautorisierungen (RMA) hinzugefügt. Käufer können [eine Rückgabe anfordern](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html). Wenn der Händler die Anfrage akzeptiert, kann der Käufer Aufgaben wie [Hinzufügen eines Kommentars](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html) und [Hinzufügen von Tracking-Informationen](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html) <!-- MC-34596--> ausführen.

* Unterstützung für die folgenden B2B-Funktionen hinzugefügt:
   * Unternehmen. Sie können Unternehmen [Administratoren](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html), [Benutzer](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html), [Rollen](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html) und [Teams](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html) <!-- MC-33861--> hinzufügen.
   * Firmenguthaben. Die [Firmenabfrage](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html) enthält Details zum Kreditverlauf des Unternehmens. <!-- MC-33862-->
   * Anforderungslisten. Sie können Anforderungslisten [erstellen](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html), [löschen](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html) und [aktualisieren](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html). Unterstützung umfasst auch die Möglichkeit, in einer Anforderungsliste [ Elemente mit den Formaten [Hinzufügen](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html), [Aktualisieren](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html), [Löschen](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html), [Kopieren](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html) und [Verschieben](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html) hinzuzufügen sowie Anforderungslistenelemente in den Warenkorb](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html) hinzuzufügen. <!-- MC-34312-->
...
* Unterstützung für [Vergleichslisten](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html) hinzugefügt. Käufer können [Vergleichslisten ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html) und [löschen](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html) und [Elemente hinzufügen](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html) und [entfernen](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html) zu den Vergleichslisten hinzufügen. Darüber hinaus können sich Käufer, die eine Vergleichsliste als Gastbenutzer erstellen, als Kunde anmelden und [ihre Vergleichslisten beibehalten](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html).

* Die Mutation [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html) wurde hinzugefügt und das Objekt `Customer` wurde aktualisiert, um Unterstützung beim Remote-Einkauf zu unterstützen.
...
* Das Attribut `staging` wurde zu den Attributen [`ProductInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/product-interface.html) und [`CategoryInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/category-interface.html) hinzugefügt, um zu ermitteln, ob ein Produkt bereitgestellt ist, und um die zugehörigen Kampagneninformationen anzuzeigen. <!-- MC-33897-->
...
* Für den Seitenaufbau müssen nicht mehr alle Inhaltstypen in einer Zeile platziert werden. Die Phase [Seitenaufbau](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#stage) ist jetzt zunächst leer und unterstützt das direkte Hinzufügen der folgenden Inhaltstypen zur Bühne: Zeilen, Spalten, Registerkarten, HTML-Code, Blöcke, dynamische Blöcke.

* Vordefinierte Ränder und Paddings sind für Content-Typen nicht mehr erforderlich.

* Mit dem neuen mobilen [Viewport-Umschalter](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#viewports) und dem Viewport-Bereich für Formularfeldwerte können Benutzer und Entwickler die folgenden Aktionen durchführen:
...
Die interaktive In-Product-Anleitung bietet Händlern Nutzungstipps und Informationen aus dem Admin zu neuen Funktionsankündigungen, Durchgehungshandbüchern, Onboarding-Informationen und QuickInfos.  **Administratoren müssen sich vom Administrator anmelden, um produktinterne Anleitungen zu erhalten, wenn diese Funktion nicht aktiviert ist.** Siehe [Sammlung von Nutzungsdaten](https://experienceleague.adobe.com/en/docs/commerce-admin/start/admin/admin) und [Nutzung durch Administratoren](https://experienceleague.adobe.com/en/docs/commerce-admin/config/advanced/admin#admin-usage).
...
* Es wurde ein Problem mit `StorefrontProductListWidgetWithSharedCatalogTest` behoben, durch das der Test übersprungen wurde. [GitHub-322](https://github.com/magento/partners-magento2b2b/issues/322)
...
* Den MFTF-Tests wurden aussagekräftige Titel und Beschreibungen für die Module `Company`, `CompanyCredit`, `CompanyPayment`, `CompanyShipping` und `ConfigurableSharedCatalog` hinzugefügt. [GitHub-30164](https://github.com/magento/magento2/issues/30164)
...
* Die Anwendung zeigt die Meldung `Purchase Order number is a required field` nicht mehr über dem Feld für den Couponcode an, bevor der Käufer Informationen in Bereitstellungen eingibt, in denen die Bestellung als einzige verfügbare Zahlungsoption konfiguriert wurde.
...
* Sie können jetzt Tracking- und Versandinformationen für eine RMA löschen, wenn das JavaScript-Bundling aktiviert ist.
...
* Die Anzahl der in **Stores** > **Attribut** > **Bewertung** angezeigten Bewertungen stimmt jetzt mit der Anzahl der Bewertungen in einer Bereitstellung mit mehreren Sites überein. [GitHub-30258](https://github.com/magento/magento2/issues/30258)
...
* Wenn Sie 0 mit dem Sonderpreis-Endpunkt `/rest/V1/products/special-price-information` senden, wird der Preis jetzt gespeichert und der Zeitplan wie erwartet zurückgegeben.
...
* Geplante Produktänderungen werden jetzt nach einer Ausführung mit `cron` nicht mehr gelöscht.

<!-- MC-38759-->

* Die Anwendung gibt keinen Fehler mehr aus, wenn Sie versuchen, eine Aktualisierung für eine Kategorie zu planen. Zuvor hat die Anwendung diesen Fehler ausgegeben, als Sie auf der Seite &quot;Neues Update planen&quot;auf **Speichern** geklickt haben: `Something went wrong while saving the Magento\Catalog\Api\Data\CategoryInterface`.

<!-- MC-38455-->

* Die `rest/V1/products/special-price` -API kann jetzt verwendet werden, um spezielle Produktpreise für mehrere Stores zu planen. Zuvor hatte die Anwendung einen Fehler ausgelöst, wenn ein Händler eine Preisaktualisierung für mehrere Stores für dieselbe `from` und dieselbe `to` geplant hatte, wenn zum Startzeitpunkt des neuen Zeitplans ein Rollback verfügbar war.
...
* Target-Regeln für verwandte Produkte funktionieren jetzt, wenn die `is one of` -Bedingung, die für die Funktion &quot;Produkte zur Anzeige&quot;verwendet wird, mehrere Bedingungen enthält. Wenn diese Bedingung zuvor mehrere Werte enthielt, wurde sie nicht analysiert.
...
* Header-Werte, die URLs enthalten, werden jetzt ordnungsgemäß in `ApiFunctional TestFramewor`k analysiert. [GitHub-26425](https://github.com/magento/magento2/issues/26425)
...
* Die Position des Cursors wurde von der Mitte zum Anfang des Felds **Nachricht** auf **Mein Konto** > **Gift Registry** > **Geschenkregistrierung teilen** angepasst.
...
* Die Anwendung zeigt jetzt ein Kalendersymbol neben dem Eingabefeld **Datum** an, wie es in der Storefront &quot;Konto erstellen&quot;erwartet wird.
...
**Problem**: Händler müssen die TLS-Funktion vom Administrator aktivieren, um die globale HTTP- zu HTTPS-Umleitung für alle Store-Seiten zu aktivieren. Weitere Informationen finden Sie im Artikel [HTTP zu HTTPS umleiten für alle Seiten in der Cloud (TLS erzwingen)](https://support.magento.com/hc/en-us/articles/360006296953) Knowledge Base . <!-- MC-39988-->
...
**Problem**: Die Anwendung erstellt eine Bestellung auf dem Braintree wie erwartet, wenn ein Käufer auf **Bezahlen mit Venmo** klickt, die Bestellung jedoch nicht in der Admin-Konsole erstellt. **Problemumgehung**: Keine. Siehe bekanntes Problem [2.4.2: Braintree Venmo-Zahlung funktioniert nicht](https://support.magento.com/hc/en-us/articles/360054662652/) Knowledge Base-Artikel.  <!-- BUNDLE-2894-->

### B2B bekannte Probleme

**Problem**: B2B-Käufer können Online-Zahlungsmethoden verwenden, um den normalen Bestellfluss zu umgehen. Dieses Szenario kann eintreten, wenn der Käufer seine gesamte Checkout-Summe auf 0 reduzieren kann - z. B. durch einen Promo-Code oder eine Geschenkkarte - und anschließend den Code oder die Geschenkkarte entfernen kann. Auch unter diesen Bedingungen gibt der Antrag die Bestellung für den korrekten Betrag auf der Grundlage der Preise der Artikel in seinem zugewiesenen Katalog. **Problemumgehung**: Deaktivieren Sie Geschenkkarten und Couponcodes, wenn die Online-Zahlungsmethoden für die Bestellvalidierung aktiviert sind. <!-- B2B-1603-->

**Problem**: Käufer werden zum Warenkorb weitergeleitet, wenn sie versuchen, eine Bestellung aus einer Bestellung über PayPal Express Checkout aufzugeben, wenn der **In-Context-Modus** deaktiviert ist. <!-- B2B-1604-->
...
**Ausgabe**: Rabatte für eine bestimmte Zahlungsmethode bleiben auch dann bestehen, wenn der Käufer beim letzten Checkout seine Zahlungsmethode ändert. Daher erhalten Kunden möglicherweise einen Rabatt, auf den sie keinen Anspruch haben. Dies liegt daran, dass trotz der Änderung der Zahlungsmethode weiterhin eine Warenkorbregel für die ursprüngliche Zahlungsmethode angewendet wird. **Problemumgehung**: Keine. Siehe bekanntes Problem [2.4.2 B2B: Rabatt bleibt für Online-Kaufaufträge erhalten, nachdem die Zahlungsmethode geändert wurde](https://support.magento.com/hc/en-us/articles/360054667312) Knowledge Base-Artikel. <!-- B2B-1012 -->
