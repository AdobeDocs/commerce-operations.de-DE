...
Die neue `adobe-ims-metapackage` Version 2.2.0 ist im Paket mit Adobe Commerce 2.4.6 enthalten. In dieser Version wurde keine Funktionalität geändert.<!-- CABPI-505-->
...
* Das GraphQL-Schema für Bestellungen umfasst die Funktionen für die Verwaltung von B2B-Kundenaufträgen, z. B. das Erstellen, Bearbeiten und Löschen von Bestellungen. Siehe [Kaufaufträge (B2B)](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/purchase-order/).
...
* Adobe Commerce zeigt jetzt einen genauen Zeitbereich an, in dem ein Admin-Benutzer die **[!UICONTROL Last 24 Hours]** im Dashboard &quot;Administratorstatistiken&quot;aus. Zuvor wurde in Adobe Commerce ein falscher Zeitraum angezeigt. Dies trat auf, weil die Zeitzone der Datenbank unverändert blieb.
...
* Die veraltete Media Gallery ist jetzt standardmäßig deaktiviert. Zuvor **[!UICONTROL Enable old Media gallery]** wurde auf **[!UICONTROL Yes]**.
...
* Die `ANDROID_PAY_CARD` konstante `Braintree/Ui/Component/Report/Listing/Column/PaymentType.php` ersetzt `GOOGLE_PAY_CARD`. Hierdurch werden Probleme mit dem Braintree-Bericht behoben.
...
* Die **[!UICONTROL Use Config Settings]** Kontrollkästchen für die **[!UICONTROL Enable RMA]** speichert nun den Wert wie erwartet, wenn ein Produkt gespeichert wird.
