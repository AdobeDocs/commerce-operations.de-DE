...
## 2.4.6 Beta1-Testumgebung

Adobe Commerce 2.4.6-beta1 wurde mit den folgenden Komponentenversionen getestet:
...
Diese Version umfasst acht Sicherheitsverbesserungen und Verbesserungen der Plattformsicherheit. Diese Sicherheitskorrekturen wurden auf Adobe Commerce 2.4.5-p1 und Adobe Commerce 2.4.4-p3 zurückportiert.
...
PHP 8.1 wird weiterhin vollständig unterstützt. Adobe Commerce 2.4.6 GA wird Unterstützung für PHP 8.2 beinhalten, aber die Verzögerung bei der Veröffentlichung von PHP 8.2 hat uns daran gehindert, Unterstützung für PHP in diese Beta-Version aufzunehmen. <!-- AC-6598 -->

Die Unterstützung für PHP 7.4 wurde aus dieser Version entfernt. Sie können Adobe Commerce nicht auf PHP 7.4 ausführen.

Adobe Commerce 2.4.6-Beta1 unterstützt jetzt:
...
* MariaDB 10.6 (LST-Version). Diese Version ist weiterhin mit MariaDB 10.4 kompatibel, wir empfehlen jedoch ein Upgrade auf MariaDB 10.6. <!-- AC-6921 -->
...
Hunderte von Problemen werden im Adobe Commerce 2.4.6-Kerncode behoben. Nachfolgend wird eine Teilmenge der in Adobe Commerce 2.4.6-beta1 enthaltenen behobenen Probleme beschrieben.
...
* Wird ausgeführt `bin/magento set:di:com -vvv` (oder mit dem `-v` oder `-vv` -Optionen) gibt jetzt eine informative Meldung zum Fehler zurück. [GitHub-35391](https://github.com/magento/magento2/issues/35391)
...
* Die `composer install` body überschreibt nicht mehr `.gitignore` Dateien. [GitHub-32888](https://github.com/magento/magento2/issues/32888)

<!-- AC-6671-->

* Läuft `php bin/magento staticdata:remove` , um Beispieldaten nach der Aktualisierung zu entfernen, schlägt mit diesem Fehler nicht mehr fehl: `Undefined constant "MagentoHackathon\Composer\Magento\Deploystrategy\GLOB_BRACE`. [GitHub-36062](https://github.com/magento/magento2/issues/36062)
...
* Käufer können die reCAPTCHA-Validierung nicht mehr umgehen, wenn sie eine Bestellung mit Braintree aufgeben, wenn reCAPTCHA aktiviert ist.

<!-- BUNDLE-3185-->

* Die ReCAPTCHA-Validierung beim Checkout für Bestellungen, die an mehrere Ziele gesendet werden, funktioniert jetzt erwartungsgemäß.
...
* SEO-freundliche URLs werden jetzt für Produkte generiert, deren `url_key` -Attribut auf der Store-Ansichtsebene überschrieben.
