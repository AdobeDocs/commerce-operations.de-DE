...
* **3DS-Unterstützung für[!DNL Google Pay]** - Enthaltene Unterstützung der 3DS-Verifizierung für die [!DNL Google Pay] nicht-Token-Karten. Weitere Informationen finden Sie in der Dokumentation [&#128279;](https://developer.paypal.com/braintree/docs/guides/3d-secure/advanced-options/javascript/v3#verify-google-pay-card-using-3ds) Braintree .
...
* **Unterstützung für Auftragsstornierung**. Die [cancelOrder](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/cancel-order/)-Mutation ermöglicht es einem Kunden, eine Bestellung zu stornieren, indem er ihre Kennung und einen Stornierungsgrund übergibt. <!-- LYNX-197 -->
  ...
  * Die neuen `order_cancellation_enabled` und `order_cancellation_reasons.description` Antwortfelder in der `storeConfig`
    Abfrage unterstützt vom Benutzer initiierte Anfragen zur Stornierung von Bestellungen. Siehe [Konfiguration der Stornierung von Bestellungen eines Geschäfts abfragen](https://developer.adobe.com/commerce/webapi/graphql/schema/store/queries/store-config#query-a-stores-order-cancellation-configuration)
...
* [Integration von Adobe Commerce mit Adobe IMS](https://experienceleague.adobe.com/docs/commerce-admin/start/admin/ims/adobe-ims-integration-overview.html?lang=de)
...
* Magento Open Source fügt den Produktbeschreibungstext nicht mehr in das **[!UICONTROL Meta Description]** der Produktdetailseite ein, wenn dieses Feld leer gelassen wurde. Wenn eine Produktbeschreibung HTML-Code enthielt, der von Page Builder oder einem anderen HTML-Editor generiert wurde, wurde HTML zuvor im Feld Meta-**[!UICONTROL Description]** angezeigt, und Sie konnten dieses Feld nicht leer lassen.
...
* Der Name der `reponseBody`-Variablen wurde in `app/code/Magento/CatalogRule/Controller/Adminhtml/Promo/Catalog/NewConditionHtml.php`.[-38093](https://github.com/magento/magento2/issues/38093) in `responseBody` geändert
...
* Der Import von Stock-Quellen und Kundenadressen mit der Option **[!UICONTROL Customers and Addresses (single file)]** wurde jetzt erfolgreich abgeschlossen.
...
* Beim Hinzufügen eines dynamischen Bausteins ohne Inhalt tritt kein Fehler mehr auf.
...
* Die Attribute `taxes`, `itemized_taxes` und `additional_itemized_taxes` Erweiterung wurden `Magento\Sales\Api\Data\OrderInterface` hinzugefügt. Mit diesen Attributen können Sie angewendete Steuern mit REST-Aufrufen für Bestellungen speichern.
