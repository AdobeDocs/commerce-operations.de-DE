...
* Die `bin/magento config:set graphql/session/disable 1` -Befehl ermöglicht Händlern, die Erstellung von Sitzungs-Cookies für alle Vorgänge in GraphQL vollständig zu deaktivieren. Standardmäßig erstellt die Anwendung Open Source diese Cookies und verlässt sich bei der Autorisierung auf sie, was sich auf die Leistung auswirkt. In Zukunft wird empfohlen, Token als einzige Form der Autorisierung für GraphQL-Anforderungen zu verwenden. Es wird empfohlen, keine Sitzungs-Cookies allein oder in Verbindung mit Autorisierungstoken zu verwenden. Siehe [GraphQL-Autorisierung](https://devdocs.magento.com/guides/v2.4/graphql/authorization-tokens.html). <!-- B2B-2204 -->

* Sitzungs-Cookies werden jetzt in GraphQL-Vorgängen nur bei Bedarf mit Klassenprofilen gestartet. <!-- B2B-2217 -->

* Die Sitzungsnutzung wurde aus `http` -Header-Prozessoren in GraphQL wie Store, Kunde oder Währung. <!-- B2B-2224 -->
...
* Fehlt `price_range` wurde zum GraphQL hinzugefügt. `BundleItemOption` Typ. [GitHub-35010](https://github.com/magento/magento2/issues/35010)
...
* Magento Open Source-Sitzungen enden nicht mehr, nachdem eine GraphQL-Anfrage gestellt wurde. Zuvor wurde die Variable `ClearCustomerSessionAfterRequest` -Plug-in meldete den Käufer ab. [GitHub-34550](https://github.com/magento/magento2/issues/34550)
...
* Sie können jetzt zwischen Store-Ansichten wechseln, wenn Website-Beschränkungen aktiviert sind. Zuvor wurde aufgrund von Problemen mit dem Store-Ansichtsschalter das Wechseln von Store-Ansichten verhindert.
