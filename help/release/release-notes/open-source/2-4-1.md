...
* Käufer können beim Checkout die Optionen für Geschenkgutachten auswählen. GraphQL umfasst jetzt Optionen für Geschenkgutachten für verschiedene Warenkorbtypen. Siehe [`setGiftOptionsOnCart` Mutation](https://developer.adobe.com/commerce/webapi/graphql/mutations/set-gift-options.html) und [`updateCartItems` Mutation](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-cart-items.html). _Fehlerbehebung, die von Oleh Usik in Pull-Anforderungen gesendet wurde: [28519](https://github.com/magento/magento2/pull/28105), [27956](https://github.com/magento/magento2/pull/27956), [28072](https://github.com/magento/magento2/pull/28072), [28072](https://github.com/magento/magento2/pull/28072). [GitHub-28519](https://github.com/magento/magento2/issues/28519)
...
* Zusätzliche Unterstützung für Wunschlisten in Magento Open Source. Sie können [Elemente ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-wishlist.html) zu, [Elemente aktualisieren](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html) in und [Elemente entfernen](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-wishlist.html) aus einer Wunschliste. _Fehlerbehebung, die von Eduard Chitoraga in der Pull-Anforderung gesendet wurde [28205](https://github.com/magento/magento2/pull/28205)_. [GitHub-28551](https://github.com/magento/magento2/issues/28551)
...
* Es wurden Themen zu Klarna GraphQL in der Zahlungsmethode [Klarna](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/klarna.html) und [`createKlarnaPaymentsSession`](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-klarna-payments-session.html) hinzugefügt oder aktualisiert.
...
* Der Navigationsfilter mit mehreren Mustern entspricht nun den in der gesamten Magento Open Source verwendeten Standardfiltern. _Fehlerbehebung, die von Bartłomiej Szubert in der Pull-Anforderung gesendet wurde [28015](https://github.com/magento/magento2/pull/28015)_. [GitHub-28011](https://github.com/magento/magento2/issues/28011)
...
* Es wurden Tests hinzugefügt, um die **Verwendet in** -Links für ein Bild in der Mediengalerie abzudecken. _Fehlerbehebung, die von Nazar Klovanych in der Pull-Anforderung eingereicht wurde [29392](https://github.com/magento/magento2/pull/29392)_. [GitHub-1969](https://github.com/magento/adobe-stock-integration/issues/1693)
...
* Es wurde der `StorefrontShareCustomerWishlistActionGroup`-Test für die Freigabe der Kundenwunschliste mit ungültigen E-Mail-Adressen hinzugefügt. Der vorhandene Test für die Wunschlisten-Freigabe (`StorefrontShareWishlistEntityTest`) wurde umgestaltet. `StorefrontCustomerShareWishlistActionGroup` ist veraltet.
...
* Newsletter-Abonnement-E-Mails verwenden jetzt dieselben HTML-Tags wie andere Newsletter-bezogene E-Mails. _Fehlerbehebung, die von Paweł Tylek in der Pull-Anforderung gesendet wurde [27357](https://github.com/magento/magento2/pull/27357)_. [GitHub-28165](https://github.com/magento/magento2/issues/28165)

<!-- ENGCOM-7788-->

* Es wurde ein Test zum Löschen eines Newsletter-Abonnenten als Admin-Benutzer hinzugefügt. _Fehlerbehebung, die von Dmitry Tsymal in der Pull-Anforderung gesendet wurde [28972](https://github.com/magento/magento2/pull/28972)_. [GitHub-29032](https://github.com/magento/magento2/issues/29032)
...
* Die `CustomerAddressId` -Werte für einen neu erstellten Kunden werden jetzt in Anführungszeichen gesetzt. _Fehlerbehebung, die von Andrii Kalinich in der Pull-Anforderung gesendet wurde [29139](https://github.com/magento/magento2/pull/29139)_. [GitHub-28793](https://github.com/magento/magento2/issues/28793)
...
* Die Anwendung weist den Status &quot;`Complete`&quot; nicht mehr zu, nachdem sie eine Bestellung aufgerechnet hat, für die keine Zahlung erforderlich ist.
...
* Elasticsearch-Ergebnisse enthalten nun die richtigen Werte für die Attributoptionen jeder Store-Ansicht. Wenn ein Attribut `Dropdown` oder `Multiple Select` in der nicht standardmäßigen Store-Ansicht einen anderen Optionswert hat als in der standardmäßigen Store-Ansicht, indiziert Elasticsearch diesen Wert jetzt oder gibt das Produkt mit diesem Wert in den Ergebnissen zurück. Zuvor hat Elasticsearch diesen Wert nicht indiziert oder das Produkt mit diesem Wert in den Ergebnissen zurückgegeben.
...
* Polyfill für `Map`, `WeakMap`, `FormData` und `MutationObserver` werden jetzt nur nach Bedarf geladen. _Fehlerbehebung, die von Dmitry Tsymal in der Pull-Anforderung gesendet wurde [28330](https://github.com/magento/magento2/pull/28330)_. [GitHub-28377](https://github.com/magento/magento2/issues/28377)
