...
Siehe [Adobe-Sicherheitsbulletin](https://helpx.adobe.com/security/products/magento/apsb22-13.html) für die letzte Diskussion dieser behobenen Probleme.
...
* Magento Open Source gibt nach Verwendung der Variablen `addConfigurableProductsToCart` Mutation , um ein konfigurierbares Produkt direkt nach dem Ändern der Store-Ansicht zum Warenkorb hinzuzufügen.

<!-- ACP2E-176-->

* Die Magento Open Source erzeugt keinen Fehler mehr, wenn Sie die `addConfigurableProductsToCart` Mutation , um ein deaktiviertes untergeordnetes Element eines konfigurierbaren Produkts zum Warenkorb hinzuzufügen. Zuvor hatte applicationOpen Source einen Fehler wegen einer Verletzung der Integritätsbeschränkung ausgelöst.
...
* Aktualisiert `phpunit/ phpunit` auf die neueste Version für die `magento-coding-standard` Repository. [GitHub-33622](https://github.com/magento/magento2/issues/33622)
...
* Die `Magento2.Annotation.MethodAnnotationStructure` &quot;sniff&quot;schlägt nicht mehr mit einem falsch positiven fehl. [GitHub-34679](https://github.com/magento/magento2/issues/34679)
...
* Die Codebase wurde aktualisiert, um bei Verwendung der `ReflectionType::isBuiltin()` -Methode. [GitHub-34194](https://github.com/magento/magento2/issues/34194)
...
* Käufer können jetzt Braintree verwenden, um eine Bestellung über eine Rechnungsadresse ohne eine bestimmte Region in Bereitstellungen mit aktiviertem 3DS durchzuführen. Bisher wurde der Kassengang eingefroren, als der Käufer auf **Reihenfolge** und der Kauf nicht abgeschlossen werden konnte. [GitHub-34204](https://github.com/magento/magento2/issues/34204)
...
* Hinzufügung von `aria-label` -Element zur Vorlage der Storefront-Seite hinzufügen, um die Seite anzugeben, zu der der Käufer beim Klicken auf einen Link navigiert. Zuvor wurde derselbe Linktext für Links zu verschiedenen Seiten verwendet. [GitHub-33075](https://github.com/magento/magento2/issues/33075)
...
* Hinzufügung von **Heute** -Ansicht in den Dashboard-Diagrammen für Admin-Bestellungen und -Beträge angezeigt, um eine Zusammenfassung der Verkäufe und Bestellungen über den gesamten Tag hinweg zu erhalten. [GitHub-34008](https://github.com/magento/magento2/issues/34008)
...
**Problem**: Käufer können ihrem Warenkorb kein Produkt hinzufügen, wenn in Admin keine Optionen ausgewählt sind **Store** >  **Konfiguration** > **Allgemein** > **Länderoptionen** > **Länder zulassen**. Die Anwendung Open Source zeigt stattdessen den folgenden Konsolenfehler: `Failed to load resource: the server responded with a status of 400 (Bad Request)`. <!-- AC-2564-->
