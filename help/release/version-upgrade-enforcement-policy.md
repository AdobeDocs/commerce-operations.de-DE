...
description: Erfahren Sie mehr über die Durchsetzung von Versions-Upgrades für Adobe Commerce on Cloud (PaaS) - warum Adobe Upgrades, Erzwingungstermine, Deaktivierung und erforderliche Aktionen erzwingt. Übergangsbestimmungen und Migrationspfade finden Sie in der Lebenszyklusrichtlinie .
...
# Durchsetzungsrichtlinie für die Versionsaktualisierung für Adobe Commerce on Cloud (PaaS)

Wenn die reguläre Unterstützung und die erweiterte Unterstützung für eine Adobe Commerce-Version auslaufen, behält sich Adobe das Recht vor, Adobe Commerce on Cloud (PaaS)-Umgebungen zu deaktivieren, in denen diese nicht unterstützte Version noch ausgeführt wird. Die Durchsetzung des Versions-Upgrades gilt nur für von Adobe gehostete PaaS-Umgebungen. Kunden vor Ort verwalten ihre eigene Infrastruktur.
...
Wenn die Sicherheitsunterstützung für die zugrunde liegenden Softwareabhängigkeiten offiziell von Anbietern beendet wird, kann Adobe nicht mehr die erforderliche Sicherheitsabdeckung und Plattformunterstützung bereitstellen. Wenn Geschäfte weiterhin auf nicht unterstützter Infrastruktur betrieben werden, sind Kunden, ihre Kunden und Adobe einem inakzeptablen Risiko ausgesetzt. Adobe führt daher eine formale Richtlinie zur Durchsetzung des erzwungenen Versions-Upgrades ein, die definiert, wann von Adobe gehostete Cloud-Umgebungen, in denen nicht unterstützte Commerce-Versionen ausgeführt werden, deaktiviert werden.
...
**Upgrade-Erzwingungsdatum** = Allgemeine Verfügbarkeit + 3 Jahre regelmäßiger Support + 1 Jahr erweiterter Support
...
Am Veröffentlichungsdatum der Upgrade-Durchsetzung stoppt Adobe die Wartung aller Adobe Commerce on Cloud (PaaS)-Umgebungen, in denen die betroffene Release-Version noch ausgeführt wird, und behält sich das Recht vor, sie zu deaktivieren. Sie erhalten vorab Benachrichtigungen zu wichtigen Meilensteinen, bevor das Versions-Upgrade durchgesetzt wird. Adobe stellt vor der Deaktivierung der Umgebung ein Datenexportfenster zur Verfügung, damit Sie Ihre Daten abrufen können.
