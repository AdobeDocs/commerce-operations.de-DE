...
Um [!DNL RequireJS] zur Verwendung Ihrer Bundles zu erhalten, fügen Sie der `onModuleBundleComplete`-Datei nach dem `modules`-Knoten einen `build.js`-Callback hinzu:
